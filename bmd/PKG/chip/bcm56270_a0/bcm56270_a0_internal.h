...
#ifndef __BCM56270_A0_INTERNAL_H__
#define __BCM56270_A0_INTERNAL_H__
...
extern int
bcm56270_a0_unicore_phy_init(int unit, int port);

extern int
bcm56270_a0_xlport_reset(int unit, int port);
...
extern int
bcm56270_a0_tsc_block_disable(int unit, uint32_t disable_tsc);

extern int
bcm56270_a0_xlblock_number_get(int unit, int port);

extern int
bcm56270_a0_xlblock_subport_get(int unit, int port);

extern int
bcm56270_a0_xport_pbmp_get(int unit, int flag, cdk_pbmp_t *pbmp);

extern int
bcm56270_a0_p2l(int unit, int port, int inverse);

extern int
bcm56270_a0_p2m(int unit, int port, int inverse);
...
extern int
bcm56270_a0_xl_phy_core_port_mode(int unit, int port, int *phy_mode_xl, int *core_mode_xl);
...
extern int
bcm56270_mac_xl_timestamp_byte_adjust_set(int unit, int port);

#define P2PP(_u,_p) bcm56270_a0_p2l(_u, _p, 0)
#define PP2P(_u,_p) bcm56270_a0_p2l(_u, _p, 1)
#define P2M(_u,_p) bcm56270_a0_p2l(_u, _p, 0)
#define M2P(_u,_p) bcm56270_a0_p2l(_u, _p, 1)
#define P2L(_u,_p) bcm56270_a0_p2l(_u, _p, 0)
#define L2P(_u,_p) bcm56270_a0_p2l(_u, _p, 1)

#define XLPORT_SUBPORT(_u,_p)    bcm56270_a0_xlblock_subport_get(_u,_p)
#define XLPORT_BLKIDX(_u, _p)    bcm56270_a0_xlport_block_index_get(_u, _p)
#define MXQPORT_SUBPORT(_u, _p)  bcm56270_a0_mxqblock_subport_get(_u, _p)
#define MXQPORT_BLKIDX(_u, _p)   bcm56270_a0_mxqport_block_index_get(_u, _p)

#define LB_PORT                 13
#define LB_LPORT                13
#define UC_Q_BASE_CMIC_PORT     48
#define UC_Q_BASE_LB_PORT       24

#define UC_COSQ_BASE(_u, _p) bcm56270_a0_uc_cosq_base(_u,_p)
#define NUM_UC_COSQ(_u, _p)  bcm56270_a0_uc_queue_num(_u,_p,0)

#endif /* __BCM56270_A0_INTERNAL_H__ */
