...
#ifndef __BCM53600_A0_BMD_H__
#define __BCM53600_A0_BMD_H__
...
extern int
bcm53600_a0_bmd_attach(int unit);
...
/* Sets the port mode */
extern int
bcm53600_a0_bmd_port_mode_set(int unit, int port, bmd_port_mode_t mode, uint32_t flags);

/* Gets the port mode */
extern int
bcm53600_a0_bmd_port_mode_get(int unit, int port, bmd_port_mode_t *mode, uint32_t *flags);
