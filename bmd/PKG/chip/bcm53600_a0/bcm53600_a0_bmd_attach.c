...
static phy_bus_t *bcm53600_a0_fport_phy_bus[] = {
#ifdef PHY_BUS_BCM53600_MIIM_INT_INSTALLED
    &phy_bus_bcm53600_miim_int,
#endif        
    NULL
};

static phy_bus_t *bcm53600_a0_gport_phy_bus[] = {
#ifdef PHY_BUS_BCM53600_MIIM_INT_INSTALLED
    &phy_bus_bcm53600_miim_int,
#endif        
#ifdef PHY_BUS_BCM53600_MIIM_EXT_INSTALLED
    &phy_bus_bcm53600_miim_ext,
#endif
    NULL
};
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm53600_a0_fport_phy_bus);
#endif
    }
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm53600_a0_gport_phy_bus);
#endif
    }
