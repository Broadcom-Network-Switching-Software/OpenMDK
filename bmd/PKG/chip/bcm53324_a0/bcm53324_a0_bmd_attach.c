...
static phy_bus_t *bcm53324_a0_phy_bus[] = {
#ifdef PHY_BUS_BCM53324_MIIM_INT_INSTALLED
    &phy_bus_bcm53324_miim_int,
#endif
#ifdef PHY_BUS_BCM53324_MIIM_EXT_INSTALLED
    &phy_bus_bcm53324_miim_ext,
#endif
    NULL
};
...
#endif
int
bcm53324_a0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm53324_a0_phy_bus);
#endif
    }
