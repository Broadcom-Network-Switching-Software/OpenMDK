...
#ifndef __BCM56340_A0_INTERNAL_H__
#define __BCM56340_A0_INTERNAL_H__
...
#define XPORT_FLAG_XTPORT       (1 << BLKTYPE_XTPORT)
#define XPORT_FLAG_XWPORT       (1 << BLKTYPE_XWPORT)
#define XPORT_FLAG_ALL          (XPORT_FLAG_XLPORT | XPORT_FLAG_XTPORT | XPORT_FLAG_XWPORT)
...
extern int
bcm56340_a0_unicore_phy_init(int unit, int port);
...
#define P2L(_u,_p) bcm56340_a0_p2l(_u,_p,0)
#define L2P(_u,_p) bcm56340_a0_p2l(_u,_p,1)

#define P2M(_u,_p) bcm56340_a0_p2m(_u,_p,0)
#define M2P(_u,_p) bcm56340_a0_p2m(_u,_p,1)

#define XPORT_BLKIDX(_p) ((_p - 1) >> 2)
#define XPORT_SUBPORT(_p) ((_p - 1) & 0x3)

#endif /* __BCM56340_A0_INTERNAL_H__ */
