...
int
bcm53128_a0_bmd_port_stp_set(int unit, int port, bmd_stp_state_t state)
{
    int ioerr = 0;
    int hw_state;
    MST_TABr_t stg_tab;
    ...
    case 6: MST_TABr_SPT_STA6f_SET(stg_tab, hw_state); break;
    case 7: MST_TABr_SPT_STA7f_SET(stg_tab, hw_state); break;
    default:
