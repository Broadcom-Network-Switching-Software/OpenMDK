...
static phy_bus_t *bcm56304_b0_gport_phy_bus[] = {
...
static phy_bus_t *bcm56304_b0_xport_phy_bus[] = {
...
int
bcm56304_b0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm56304_b0_gport_phy_bus);
#endif
    }
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm56304_b0_xport_phy_bus);
#endif
    }
#endif
