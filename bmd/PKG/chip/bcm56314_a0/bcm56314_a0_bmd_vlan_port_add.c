...
int
bcm56314_a0_bmd_vlan_port_add(int unit, int vlan, int port, uint32_t flags)
{
    int ioerr = 0;
    ...
    if (port == CMIC_PORT && (flags & BMD_VLAN_PORT_F_UNTAGGED)) {
        /* Untagged packets to CPU is not supported */
        return CDK_E_PARAM;
    }
