...
int
bcm53314_a0_bmd_tx(int unit, const bmd_pkt_t *pkt)
{
#if BMD_CONFIG_INCLUDE_DMA == 1
    TX_DCB_t *dcb;
    dma_addr_t bdcb;
    ...
    hdr_size = (pkt->flags & BMD_PKT_F_UNTAGGED) ? 12 : 16; 
    ...
    TX_DCB_ADDRf_SET(dcb[1], pkt->baddr + 16); 
    TX_DCB_BYTE_COUNTf_SET(dcb[1], pkt->size - 16); 
