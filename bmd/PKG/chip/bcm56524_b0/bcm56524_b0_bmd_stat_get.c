...
int
bcm56524_b0_bmd_stat_get(int unit, int port, bmd_stat_t stat, bmd_counter_t *counter)
{
    int ioerr = 0;
    int collect_bigmac_counters = 1;
    RRPKTr_t rrpkt;
    RDBGC0r_t rdbgc0;
    ...
    if (XPORT_CONFIGr_XPORT_ENf_GET(xport_cfg) == 0) {
        collect_bigmac_counters = 0;
    }
