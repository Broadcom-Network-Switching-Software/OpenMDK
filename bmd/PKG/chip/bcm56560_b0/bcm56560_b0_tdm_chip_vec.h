 ...
 * All Rights Reserved.$
 *
 * TDM vector library for BCM56560
 */
#ifndef __BCM56560_B0_TDM_CHIP_VEC_H__
#define __BCM56560_B0_TDM_CHIP_VEC_H__

#ifndef TDM_AP_VECTOR_LIBRARY_H
#define TDM_AP_VECTOR_LIBRARY_H

extern int
tdm_b0_ap_b0_vec_load(unsigned short **map, int bw, int port_speed, int yy, int len, int num_ext_ports);

/**
@name: tdm_b0_ap_b0_vector_load
@param:
...
#endif /* __BCM56560_B0_TDM_CHIP_VEC_H__ */
