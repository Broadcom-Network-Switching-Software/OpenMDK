 ...
 */
#ifndef __BCM56560_B0_TDM_CORE_VEC_H__
#define __BCM56560_B0_TDM_CORE_VEC_H__

#ifndef TDM_VECTOR_LIBRARY_H
#define TDM_VECTOR_LIBRARY_H

extern int
tdm_b0_ap_b0_core_vec_load_b0(unsigned short **map, int bw, int port_speed, int yy, int len, int num_ext_ports);

/**
@name: tdm_b0_ap_b0_core_vec_load_b0
@param:
...
#endif /* __BCM56560_B0_TDM_CORE_VEC_H__ */
