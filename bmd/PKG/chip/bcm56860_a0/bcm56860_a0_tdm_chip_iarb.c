  ...
  */
  ...
  if ((is_x_ovs == 0) && (is_y_ovs == 0)) {
    ...
    *iarb_tdm_wrap_ptr_y = iarb_tdm_wrap_ptr_lr_y;
    ...
    TDM_COPY(iarb_tdm_tbl_y, iarb_tdm_tbl_lr_y, sizeof(int) * 512);
  }
  if ((is_x_ovs == 0) && (is_y_ovs == 1)) {
    ...
    *iarb_tdm_wrap_ptr_y = iarb_tdm_wrap_ptr_ovs_y;
    TDM_COPY(iarb_tdm_tbl_x, iarb_tdm_tbl_lr_x, sizeof(int) * 512);
    TDM_COPY(iarb_tdm_tbl_y, iarb_tdm_tbl_ovs_y, sizeof(int) * 512);
  }
  if ((is_x_ovs == 1) && (is_y_ovs == 0)) {
    ...
    *iarb_tdm_wrap_ptr_y = iarb_tdm_wrap_ptr_lr_y;
    TDM_COPY(iarb_tdm_tbl_x, iarb_tdm_tbl_ovs_x, sizeof(int) * 512);
    TDM_COPY(iarb_tdm_tbl_y, iarb_tdm_tbl_lr_y, sizeof(int) * 512);
  }
