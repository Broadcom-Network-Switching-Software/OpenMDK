...
: * 
: * Copyright 2007-2020 Broadcom Inc. All rights reserved.Copyright: Copyright 2019 Broadcom Corporation.
...
struct mn_vars_t {
	...
	int pgw1_len;
	int mmu_len;
	int **pmap; /* pmap, speed and state are used for ZTE config to have backup of state,pmap, and speed */
