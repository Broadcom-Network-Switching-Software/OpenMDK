...
#include "bcm56670_a0_tdm_chip_soc.h"
...
LINKER_DECL void tdm_mn_falcon_32_40__ovs_gen(tdm_mn_chip_legacy_t *_mn_chip,int *ovs_tdm_tbl, int *ovs_spacing, int pgw_num, int * is_falcon_32_40);
LINKER_DECL void tdm_mn_check_mv_fb_config(mn_pgw_os_tdm_sel_e *mn_pgw_os_tdm_sel, tdm_mn_chip_legacy_t *_mn_chip);
...
LINKER_DECL void  tdm_mn_zte( tdm_mod_t *_tdm );
LINKER_DECL void  tdm_mn_zte_vars_backup( tdm_mod_t *_tdm );
LINKER_DECL void  tdm_mn_zte_restore_vars(tdm_mod_t *_tdm);
LINKER_DECL void  tdm_mn_zte_post_process_pgw( tdm_mod_t *_tdm );
LINKER_DECL void tdm_mn_zte_post_process_mmu(tdm_mod_t *_tdm);
...
LINKER_DECL void tdm_mn_cal_pgw_bw( tdm_mod_t *_tdm, float *pgw_io_bw, int start_offset );
...
LINKER_DECL void tdm_mn_tdm_print(int *tdm_tbl, int length);
#if 0
...
LINKER_DECL void tdm_mn_init_iarb_tdm_table (int core_bw, int *iarb_tdm_wrap_ptr_lr_x, int *iarb_tdm_tbl_lr_x); 
LINKER_DECL int  tdm_mn_set_iarb_tdm(int core_bw, int is_x_ovs, int *iarb_tdm_wrap_ptr_x, int *iarb_tdm_tbl_x);
