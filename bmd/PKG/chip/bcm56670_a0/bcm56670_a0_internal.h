...
#ifndef __BCM56670_A0_INTERNAL_H__
#define __BCM56670_A0_INTERNAL_H__

#define NUM_PHYS_PORTS          67
#define NUM_LOGIC_PORTS         67
#define NUM_MMU_PORTS           67

#define CMIC_LPORT              0
#define CMIC_PPORT              0
#define CMIC_MPORT              65
...
extern int
bcm56670_a0_tsc_xgxs_reset(int unit, int port, int tsc_idx);

extern int
bcm56670_a0_cport_init(int unit, int port);
...
extern int
bcm56670_a0_clg2port_init(int unit, int port);
...
extern int
bcm56670_a0_clport_block_index_get(int unit, int port);
...
extern int
bcm56670_a0_portctrl_enable_set(int unit, int port, uint32_t flags, int enable);

extern void
bcm56670_a0_xlmac_drain_cell(int unit, int port);

extern void
bcm56670_a0_clmac_drain_cell(int unit, int port);

extern void
bcm56670_a0_clg2mac_drain_cell(int unit, int port);
...
#define P2L(_u,_p) bcm56670_a0_p2l(_u,_p,0)
#define L2P(_u,_p) bcm56670_a0_p2l(_u,_p,1)

#define P2M(_u,_p) bcm56670_a0_p2m(_u,_p,0)
#define M2P(_u,_p) bcm56670_a0_p2m(_u,_p,1)
#define SPEED_MAX(_u,_p) bcm56670_a0_port_speed_max(_u,_p)

#define IS_100G_DISABLED(_u,clp_blk) bcm56670_a0_is_cblk_disabled(_u,clp_blk)
#define IS_100G_ENABLED(_u, _i) (!IS_100G_DISABLED(_u, _i))
...
#define IS_OVERSUB_PORT(_u,_p) bcm56670_a0_is_ovrs_port(_u,_p)

#define IS_FALCON(_u,_p) bcm56670_a0_port_is_falcon(_u,_p)
#define IS_CPRI(_u,_p) bcm56670_a0_port_is_cpri(_u,_p)

#define FREQ(_u) bcm56670_a0_get_core_frequency(_u)

#define CHIP_FREQ_MASK 0xFFF00000

#endif /* __BCM56670_A0_INTERNAL_H__ */
