...
static phy_bus_t *bcm56334_phy_bus[] = {
#ifdef PHY_BUS_BCM56334_MIIM_INT_INSTALLED
    &phy_bus_bcm56334_miim_int,
#endif
#ifdef PHY_BUS_BCM956334K28_MIIM_EXT_INSTALLED
    &phy_bus_bcm956334k28_miim_ext,
#endif
    NULL
};
...
int
bcm56334_a0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm56334_phy_bus);
#endif
    }
