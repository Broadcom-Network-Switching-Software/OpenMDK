...
static phy_bus_t *bcm53010_a0_phy_bus[] = {
#ifdef PHY_BUS_ROBO_MIIM_INT_INSTALLED
    &phy_bus_robo_miim_int,
#endif
#ifdef PHY_BUS_ROBO_MIIM_EXT_INSTALLED
    &phy_bus_bcm53010_miim_ext,
#endif
    NULL
};
...
int
bcm53010_a0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm53010_a0_phy_bus);
#endif
    }
