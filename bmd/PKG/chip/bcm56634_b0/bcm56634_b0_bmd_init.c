...
static uint8_t tdmb526[110] = {
     2, 26, 27, 28, 14, 29, 46, 50, 38,  3,
    26, 27, 28, 15, 29, 46, 50, 54,  4, 26,
    27, 28, 16, 29, 46, 50, 54,  5, 26, 27,
    28, 17, 29, 46, 50, 39,  6, 26, 27, 28,
    18, 29, 46, 50, 54,  7, 26, 27, 28, 19,
    29, 46, 50, 54,  1,  8, 26, 27, 28, 20,
    29, 46, 50, 40,  9, 26, 27, 28, 21, 29,
    46, 50, 54, 10, 26, 27, 28, 22, 29, 46,
    50, 54, 11, 26, 27, 28, 23, 29, 46, 50,
    41, 12, 26, 27, 28, 24, 29, 46, 50, 54,
    13, 26, 27, 28, 25, 29, 46, 50, 54, 0 };

static uint8_t tdmb630[228] = {
    30, 26, 34, 27, 38, 28, 42, 46, 29, 50, 
    26, 31, 27, 35, 39, 28, 43, 29, 47, 26, 
    51, 32, 27, 36, 28, 40, 29, 54, 44, 26, 
    48, 27, 52, 28, 33, 37, 29, 41, 26, 45, 
    27, 49, 53, 28, 30, 29, 34, 26, 38, 42, 
    27, 46, 28, 50, 29, 54,  1, 31, 26, 35, 
    27, 39, 28, 43, 47, 29, 51, 26, 32, 27, 
    36, 40, 28, 44, 29, 48, 26, 52, 33, 27, 
    37, 28, 41, 29, 54, 45, 26, 49, 27, 53, 
    28, 30, 34, 29, 38, 26, 42, 27, 46, 50, 
    28, 31, 29, 35, 26, 39, 43, 27, 47, 28, 
    51, 29, 54,  0, 32, 26, 36, 27, 40, 28, 
    44, 48, 29, 52, 26, 33, 27, 37, 41, 28, 
    45, 29, 49, 26, 53, 30, 27, 34, 28, 38, 
    29, 54, 42, 26, 46, 27, 50, 28, 31, 35, 
    29, 39, 26, 43, 27, 47, 51, 28, 32, 29, 
    36, 26, 40, 44, 27, 48, 28, 52, 29, 54, 
     1, 33, 26, 37, 27, 41, 28, 45, 49, 29, 
    53, 26, 30, 27, 34, 38, 28, 42, 29, 46, 
    26, 50, 31, 27, 35, 28, 39, 29, 54, 43, 
    26, 47, 27, 51, 28, 32, 36, 29, 40, 26, 
    44, 27, 48, 52, 28, 33, 29, 37, 26, 41, 
    45, 27, 49, 28, 53, 29, 54, 0 };

static uint8_t tdmb634a[114] = {
    26,  2, 27, 14, 28, 30, 29, 26, 34, 27, 
...
static uint8_t tdmb636a[114] = {
    26,  2, 27, 30, 28, 42, 29, 26, 50, 27, 
     3, 28, 34, 29, 26, 42, 27, 50, 28,  4, 
    29, 26, 38, 27, 42, 28, 50, 29, 26,  5, 
    27, 31, 28, 42, 29, 26, 50, 27,  6, 28, 
    35, 29, 26, 42, 27, 50, 28,  7, 29, 26, 
    39, 27, 42, 28, 50, 29,  1, 26,  8, 27, 
    32, 28, 42, 29, 26, 50, 27,  9, 28, 36, 
    29, 26, 42, 27, 50, 28, 10, 29, 26, 40, 
    27, 42, 28, 50, 29, 26, 11, 27, 33, 28, 
    42, 29, 26, 50, 27, 12, 28, 37, 29, 26, 
    42, 27, 50, 28, 13, 29, 26, 41, 27, 42, 
    28, 50, 29,  0 };

static uint8_t tdmb638a[114] = {
    26, 30, 27, 38, 28, 42, 29, 26, 50, 27, 
    30, 28, 38, 29, 26, 42, 27, 50, 28, 30, 
    29, 26, 38, 27, 42, 28, 50, 29, 26, 30, 
    27, 38, 28, 42, 29, 26, 50, 27, 30, 28, 
    38, 29, 26, 42, 27, 50, 28, 30, 29, 26, 
    38, 27, 42, 28, 50, 29,  1, 26, 30, 27, 
    38, 28, 42, 29, 26, 50, 27, 30, 28, 38, 
    29, 26, 42, 27, 50, 28, 30, 29, 26, 38, 
    27, 42, 28, 50, 29, 26, 30, 27, 38, 28, 
    42, 29, 26, 50, 27, 30, 28, 38, 29, 26, 
    42, 27, 50, 28, 30, 29, 26, 38, 27, 42, 
    28, 50, 29, 0 };

static uint8_t tdmb639a[114] = {
     2, 26, 54, 27, 14, 28, 29, 30, 50,  3,
    38, 42, 26, 15, 27, 28, 29, 30,  4, 50,
    38, 42, 16, 26, 27, 54, 28, 29,  5, 30,
    50, 38, 17, 42, 54, 26, 27,  6, 28, 29,
    30, 18, 50, 38, 42, 26,  7, 54, 27, 28,
    19, 29, 30, 50, 38, 42,  1,  8, 26, 54, 
    27, 20, 28, 29, 30, 50,  9, 38, 42, 26,
    21, 27, 28, 29, 30, 10, 50, 38, 42, 22,
    26, 27, 54, 28, 29, 11, 30, 50, 38, 23,
    42, 54, 26, 27, 12, 28, 29, 30, 24, 50,
    38, 42, 26, 13, 54, 27, 28, 25, 29, 30,
    50, 38, 42, 0 };
...
int
bcm56634_b0_xport_init(int unit, int port)
{
    int ioerr = 0;
...
bcm56634_b0_bmd_init(int unit)
{
    ...
    EDATABUF_XQP_FLEXPORT_CONFIGr_t fcfg;
    ...
    if (idx >= PIPE_RESET_TIMEOUT_MSEC) {
        CDK_WARN(("bcm56634_b0_bmd_init[%d]: IPIPE reset timeout\n", unit));
    ...
    if (idx >= PIPE_RESET_TIMEOUT_MSEC) {
        CDK_WARN(("bcm56634_b0_bmd_init[%d]: EPIPE reset timeout\n", unit));
        return ioerr ? CDK_E_IO : CDK_E_TIMEOUT;
    }
    ...
    CDK_XGS_BLKTYPE_PBMP_GET(unit, BLKTYPE_GPORT, &pbmp);
    tdm_table = tdmb634a;
    tdm_size = COUNTOF(tdmb634a);
    if (CDK_XGS_FLAGS(unit) & CHIP_FLAG_XQ0_XE) {
        tdm_table = tdmb639a;
        tdm_size = COUNTOF(tdmb639a);
        if (CDK_PBMP_IS_NULL(pbmp)) {
            tdm_table = tdmb638a;
            tdm_size = COUNTOF(tdmb638a);
        }
        flexp = 0x2d;
    } else if (CDK_XGS_FLAGS(unit) & CHIP_FLAG_XQ4_XE) {
        tdm_table = tdmb526;
        tdm_size = COUNTOF(tdmb526);
        flexp = 0x30;
    } else if (CDK_XGS_FLAGS(unit) & CHIP_FLAG_XQ3_XE) {
        tdm_table = tdmb636a;
        tdm_size = COUNTOF(tdmb636a);
        flexp = 0x28;
    } else if (CDK_PBMP_IS_NULL(pbmp)) {
        tdm_table = tdmb630;
        tdm_size = COUNTOF(tdmb630);
    }

    /* Initialize XQPORT flex mode */
    if (flexp) {
        ioerr += READ_EDATABUF_XQP_FLEXPORT_CONFIGr(unit, &fcfg);
        EDATABUF_XQP_FLEXPORT_CONFIGr_EGR_XQP_PORT_INT_RESETf_SET(fcfg, flexp);
        ioerr += WRITE_EDATABUF_XQP_FLEXPORT_CONFIGr(unit, fcfg);
        EDATABUF_XQP_FLEXPORT_CONFIGr_EGR_XQP_PORT_MODEf_SET(fcfg, flexp);
        ioerr += WRITE_EDATABUF_XQP_FLEXPORT_CONFIGr(unit, fcfg);
        EDATABUF_XQP_FLEXPORT_CONFIGr_EGR_XQP_PORT_INT_RESETf_SET(fcfg, 0);
        ioerr += WRITE_EDATABUF_XQP_FLEXPORT_CONFIGr(unit, fcfg);
    }
    ...
    /* Enable GPORTs (if present) */
    CDK_XGS_BLKTYPE_PBMP_GET(unit, BLKTYPE_GPORT, &pbmp);
    CDK_PBMP_ITER(pbmp, port) {
        ioerr += READ_GPORT_MODE_REGr(unit, &gport_mode, -1);
        GPORT_MODE_REGr_GPORT_MODE_BITSf_SET(gport_mode, 1);
        ioerr += WRITE_GPORT_MODE_REGr(unit, gport_mode, -1);
        break;
    }
    ...
    for (idx = 0; idx < COUNTOF(xq_xports); idx++) {
        ...
        xq_mode = 1;
        if ((idx == 0 && (CDK_XGS_FLAGS(unit) & CHIP_FLAG_XQ0_XE)) ||
            (idx == 2 && (CDK_XGS_FLAGS(unit) & CHIP_FLAG_XQ2_XE)) ||
            (idx == 3 && (CDK_XGS_FLAGS(unit) & CHIP_FLAG_XQ3_XE)) ||
            (idx == 4 && (CDK_XGS_FLAGS(unit) & CHIP_FLAG_XQ4_XE)) ||
            (idx == 5 && (CDK_XGS_FLAGS(unit) & CHIP_FLAG_XQ5_XE))) {
            /* Use XE mode */
            xq_mode = 2;
        }
        ioerr += READ_XQPORT_MODE_REGr(unit, &xqport_mode, port);
        XQPORT_MODE_REGr_XQPORT_MODE_BITSf_SET(xqport_mode, xq_mode);
    ...
    CDK_PBMP_ITER(pbmp, port) {
        if (BMD_PORT_PROPERTIES(unit, port) & (BMD_PORT_HG | BMD_PORT_XE)) {
            ioerr += bcm56634_b0_xport_init(unit, port);
        } else {
            ioerr += _gport_init(unit, port);
        }
        if (CDK_SUCCESS(rv)) {
