 ...
 */
#ifndef __BCM56560_A0_TDM_CHIP_METHODS_H__
#define __BCM56560_A0_TDM_CHIP_METHODS_H__

#ifndef TDM_AP_PREPROCESSOR_PROTOTYPES_H
#define TDM_AP_PREPROCESSOR_PROTOTYPES_H

#include "bcm56560_a0_tdm_chip_soc.h"
...
LINKER_DECL int tdm_ap_lls_scheduler(struct ap_ll_node *pgw_tdm, tdm_ap_chip_legacy_t *ap_chip, ap_pgw_pntrs_t *pntrs_pkg, ap_pgw_scheduler_vars_t *vars_pkg, int *pgw_tdm_tbl[AP_LR_LLS_LEN], int *ovs_tdm_tbl[AP_OS_LLS_GRP_LEN], int op_flags[2]);
...
#endif /* __BCM56560_A0_TDM_CHIP_METHODS_H__ */
