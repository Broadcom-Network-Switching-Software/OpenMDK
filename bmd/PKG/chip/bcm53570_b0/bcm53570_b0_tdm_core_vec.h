...
#ifndef __BCM53570_B0_TDM_CORE_VEC_H__
#define __BCM53570_B0_TDM_CORE_VEC_H__

#ifndef TDM_VECTOR_LIBRARY_H
#define TDM_VECTOR_LIBRARY_H

extern int
tdm_gh2_core_vec_load(unsigned short **map, int bw, int port_speed, int yy, int len, int num_ext_ports);

/**
@name: tdm_gh2_core_vec_load
@param:
...
#endif /* __BCM53570_B0_TDM_CORE_VEC_H__ */
