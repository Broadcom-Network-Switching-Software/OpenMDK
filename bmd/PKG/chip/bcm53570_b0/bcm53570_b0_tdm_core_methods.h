...
#ifndef __BCM53570_B0_TDM_CORE_METHODS_H__
#define __BCM53570_B0_TDM_CORE_METHODS_H__
...
LINKER_DECL int tdm_gh2_core_vbs_scheduler_lr( tdm_mod_t *_tdm );
...
LINKER_DECL int tdm_gh2_core_vbs_scheduler_wrapper(tdm_mod_t *_tdm);
...
LINKER_DECL void tdm_gh2_col_transpose( tdm_mod_t *_tdm );
...
LINKER_DECL int tdm_gh2_core_postalloc_vmap(unsigned short **vector_map, int freq, unsigned short spd, short *yy, short *y, int lr_idx_limit, unsigned short lr_stack[TDM_AUX_SIZE], int token, const char* speed, int num_ext_ports, int vmap_wid, int vmap_len);
...
LINKER_DECL void tdm_gh2_core_print_config( tdm_mod_t *_tdm );
...
LINKER_DECL int tdm_gh2_math_div_ceil(int a, int b);
LINKER_DECL int tdm_gh2_math_div_floor(int a, int b);
LINKER_DECL int tdm_gh2_math_div_round(int a, int b);
...
#endif /* __BCM53570_B0_TDM_CORE_METHODS_H__ */
