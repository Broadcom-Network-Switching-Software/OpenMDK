...
/**
@name: tdm_gh2_math_div_ceil
@param:

Return (int)ceil(a/b)
 */
int tdm_gh2_math_div_ceil(int a, int b)
{
	int result=0;
...
/**
@name: tdm_gh2_math_div_floor
@param:

Return (int)floor(a/b)
 */
int tdm_gh2_math_div_floor(int a, int b)
{
	int result=0;
 ...
 */
int tdm_gh2_math_div_round(int a, int b)
{
	int result=0;
