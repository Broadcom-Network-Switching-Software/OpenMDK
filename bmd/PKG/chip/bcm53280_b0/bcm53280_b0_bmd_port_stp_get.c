...
int
bcm53280_b0_bmd_port_stp_get(int unit, int port, bmd_stp_state_t *state)
{
    ...
    switch (hw_state) {
    case 0:
        *state = bmdSpanningTreeDisabled;
        break;
    case 1:
        *state = bmdSpanningTreeBlocking;
        break;
    case 2:
        *state = bmdSpanningTreeLearning;
        break;
    case 3:
        *state = bmdSpanningTreeForwarding;
        break;
    default:
        return CDK_E_PARAM;
    }
