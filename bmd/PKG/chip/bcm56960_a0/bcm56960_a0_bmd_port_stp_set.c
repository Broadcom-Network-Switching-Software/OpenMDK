...
int 
bcm56960_a0_bmd_port_stp_set(int unit, int port, bmd_stp_state_t state)
{
    int ioerr = 0;
    int lport;
    int hw_state;
    ...
    if (CDK_FAILURE(bmd_xgsd_stp_state_to_hw(state, &hw_state))) {
        return CDK_E_PARAM;
    }
    ...
    case 106: STG_TABm_SP_TREE_PORT106f_SET(stg_tab, hw_state); break;
    case 107: STG_TABm_SP_TREE_PORT107f_SET(stg_tab, hw_state); break;
    case 108: STG_TABm_SP_TREE_PORT108f_SET(stg_tab, hw_state); break;
    case 109: STG_TABm_SP_TREE_PORT109f_SET(stg_tab, hw_state); break;
    case 110: STG_TABm_SP_TREE_PORT110f_SET(stg_tab, hw_state); break;
    case 111: STG_TABm_SP_TREE_PORT111f_SET(stg_tab, hw_state); break;
    case 112: STG_TABm_SP_TREE_PORT112f_SET(stg_tab, hw_state); break;
    case 113: STG_TABm_SP_TREE_PORT113f_SET(stg_tab, hw_state); break;
    case 114: STG_TABm_SP_TREE_PORT114f_SET(stg_tab, hw_state); break;
    case 115: STG_TABm_SP_TREE_PORT115f_SET(stg_tab, hw_state); break;
    case 116: STG_TABm_SP_TREE_PORT116f_SET(stg_tab, hw_state); break;
    case 117: STG_TABm_SP_TREE_PORT117f_SET(stg_tab, hw_state); break;
    case 118: STG_TABm_SP_TREE_PORT118f_SET(stg_tab, hw_state); break;
    case 119: STG_TABm_SP_TREE_PORT119f_SET(stg_tab, hw_state); break;
    case 120: STG_TABm_SP_TREE_PORT120f_SET(stg_tab, hw_state); break;
    case 121: STG_TABm_SP_TREE_PORT121f_SET(stg_tab, hw_state); break;
    case 122: STG_TABm_SP_TREE_PORT122f_SET(stg_tab, hw_state); break;
    case 123: STG_TABm_SP_TREE_PORT123f_SET(stg_tab, hw_state); break;
    case 124: STG_TABm_SP_TREE_PORT124f_SET(stg_tab, hw_state); break;
    case 125: STG_TABm_SP_TREE_PORT125f_SET(stg_tab, hw_state); break;
    case 126: STG_TABm_SP_TREE_PORT126f_SET(stg_tab, hw_state); break;
    case 127: STG_TABm_SP_TREE_PORT127f_SET(stg_tab, hw_state); break;
    case 128: STG_TABm_SP_TREE_PORT128f_SET(stg_tab, hw_state); break;
    case 129: STG_TABm_SP_TREE_PORT129f_SET(stg_tab, hw_state); break;
    case 130: STG_TABm_SP_TREE_PORT130f_SET(stg_tab, hw_state); break;
    case 131: STG_TABm_SP_TREE_PORT131f_SET(stg_tab, hw_state); break;
    case 132: STG_TABm_SP_TREE_PORT132f_SET(stg_tab, hw_state); break;
    case 133: STG_TABm_SP_TREE_PORT133f_SET(stg_tab, hw_state); break;
    case 134: STG_TABm_SP_TREE_PORT134f_SET(stg_tab, hw_state); break;
    case 135: STG_TABm_SP_TREE_PORT135f_SET(stg_tab, hw_state); break;
    default:
