...
static phy_bus_t *bcm56725_a0_xport_phy_bus[] = {
#ifdef PHY_BUS_BCM56725_MIIM_INT_INSTALLED
    &phy_bus_bcm56725_miim_int,
#endif
    NULL
};
...
int
bcm56725_a0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm56725_a0_xport_phy_bus);
#endif
    }
