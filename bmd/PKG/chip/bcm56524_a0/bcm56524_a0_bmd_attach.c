...
static phy_bus_t *bcm56524_phy_bus[] = {
#ifdef PHY_BUS_BCM56524_MIIM_INT_INSTALLED
    &phy_bus_bcm56524_miim_int,
#endif
#ifdef PHY_BUS_BCM956524K24S_MIIM_EXT_INSTALLED
    &phy_bus_bcm956524k24s_miim_ext,
#endif
    NULL
};
...
int
bcm56524_a0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
#if BMD_CONFIG_INCLUDE_PHY == 1
    phy_bus_t **phy_bus = bcm56524_phy_bus;
#endif
