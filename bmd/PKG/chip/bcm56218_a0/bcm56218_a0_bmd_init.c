...
#define PIPE_RESET_TIMEOUT_MSEC         10000
...
bcm56218_a0_bmd_init(int unit)
{
    ...
    if (idx >= PIPE_RESET_TIMEOUT_MSEC) {
        CDK_WARN(("bcm56218_a0_bmd_init[%d]: IPIPE reset timeout\n", unit));
    ...
    GPORT_CONFIGr_SEL_LCPLL_S0f_SET(gport_cfg, 1);
    GPORT_CONFIGr_SEL_LCPLL_S1f_SET(gport_cfg, 1);
