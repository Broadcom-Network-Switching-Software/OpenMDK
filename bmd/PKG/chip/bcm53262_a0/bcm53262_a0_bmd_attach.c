...
static phy_bus_t *bcm53262_a0_fport_phy_bus[] = {
#ifdef PHY_BUS_BCM53262_MIIM_INT_INSTALLED
    &phy_bus_bcm53262_miim_int,
#endif        
    NULL
};

static phy_bus_t *bcm53262_a0_gport_phy_bus[] = {
#ifdef PHY_BUS_BCM53262_MIIM_EXT_INSTALLED
    &phy_bus_bcm53262_miim_ext,
#endif
    NULL
};
...
int
bcm53262_a0_bmd_attach(int unit)
{
    int port;
    cdk_pbmp_t pbmp;
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm53262_a0_fport_phy_bus);
#endif        
    }
...
#if BMD_CONFIG_INCLUDE_PHY == 1
        bmd_phy_bus_set(unit, port, bcm53262_a0_gport_phy_bus);
#endif        
    }
