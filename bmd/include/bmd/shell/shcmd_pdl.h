...
extern int bmd_shcmd_pdl(int argc, char *argv[]);

#define BMD_SHCMD_PDL_DESC     "Show PHY Driver Library configuration"
#define BMD_SHCMD_PDL_SYNOP \
"[0|1] [[!]substr] ..."
#define BMD_SHCMD_PDL_HELP \
"Display the values of the PHY configuration variables for the current\n" \
