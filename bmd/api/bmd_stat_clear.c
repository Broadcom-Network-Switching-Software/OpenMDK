...
extern int _bd##_bmd_stat_clear(int unit, int port, bmd_stat_t stat);
#include <bmdi/bmd_devlist.h>

/* Dispatch table for this function, which uses the externs above */
#define BMD_DEVLIST_ENTRY(_nm,_vn,_dv,_rv,_md,_pi,_bd,_bc,_fn,_fl,_cn,_pf,_pd,_r0,_r1) \
_bd##_bmd_stat_clear,
static int (*__dispatch_table[])(int unit, int port, bmd_stat_t stat) =
{
#include <bmdi/bmd_devlist.h>
0
};
    ...
    bmd_stat_t stat)
{
    ...
    return __dispatch_table[dev_type](unit, port, stat);
}
