 ...
 *
 * PHY driver for BCM53540 embedded gigabit PHY.
 */
...
#define BCM53540_PHY_ID0                0xae02
#define BCM53540_PHY_ID1                0x51d0
...
/* Default LED control */
#define BCM53540_LED1_SEL(_pc)          0x0
#define BCM53540_LED2_SEL(_pc)          0x1
#define BCM53540_LED3_SEL(_pc)          0x3
#define BCM53540_LED4_SEL(_pc)          0x6
#define BCM53540_LEDCTRL(_pc)           0x8
#define BCM53540_LEDSELECT(_pc)         0x0
 ...
 */
static int
bcm53540_phy_probe(phy_ctrl_t *pc)
{
    ...
    if ((phyid0 == BCM53540_PHY_ID0 && 
        (phyid1 & ~PHY_ID1_REV_MASK) == BCM53540_PHY_ID1)) {
 ...
 */
static int
bcm53540_phy_notify(phy_ctrl_t *pc, phy_event_t event)
{
 ...
 */
static int
bcm53540_phy_reset(phy_ctrl_t *pc)
{
 ...
 */
static int
bcm53540_phy_init(phy_ctrl_t *pc)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
    ...
    LED_SELECTOR_1r_SET(led_selector_1,
            BCM53540_LED1_SEL(pc) | (BCM53540_LED2_SEL(pc) << 4));
    ioerr += WRITE_LED_SELECTOR_1r(pc, led_selector_1);

    LED_SELECTOR_2r_SET(led_selector_2,
            BCM53540_LED3_SEL(pc) | (BCM53540_LED4_SEL(pc) << 4));
    ioerr += WRITE_LED_SELECTOR_2r(pc, led_selector_2);

    LED_CTRLr_SET(led_ctrl, BCM53540_LEDCTRL(pc));
    ioerr += WRITE_LED_CTRLr(pc, led_ctrl);

    EXP_LED_SELECTORr_SET(exp_led_selector, BCM53540_LEDSELECT(pc));
 ...
 */
static int
bcm53540_phy_link_get(phy_ctrl_t *pc, int *link, int *autoneg_done)
{
 ...
 */
static int
bcm53540_phy_duplex_set(phy_ctrl_t *pc, int duplex)
{
 ...
 */
static int
bcm53540_phy_duplex_get(phy_ctrl_t *pc, int *duplex)
{
 ...
 */
static int
bcm53540_phy_speed_set(phy_ctrl_t *pc, uint32_t speed)
{
 ...
 */
static int
bcm53540_phy_speed_get(phy_ctrl_t *pc, uint32_t *speed)
{
 ...
 */
static int
bcm53540_phy_autoneg_set(phy_ctrl_t *pc, int autoneg)
{
 ...
 */
static int
bcm53540_phy_autoneg_get(phy_ctrl_t *pc, int *autoneg)
{
 ...
 */
static int
bcm53540_phy_loopback_set(phy_ctrl_t *pc, int enable)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
 ...
 */
static int
bcm53540_phy_loopback_get(phy_ctrl_t *pc, int *enable)
{
 ...
 */
static int
bcm53540_phy_ability_get(phy_ctrl_t *pc, uint32_t *abil)
{
 ...
 */
static int
bcm53540_phy_config_set(phy_ctrl_t *pc, phy_config_t cfg, uint32_t val, void *cd)
{
 ...
 */
static int
bcm53540_phy_config_get(phy_ctrl_t *pc, phy_config_t cfg, uint32_t *val, void *cd)
{
    return bcm54282_drv.pd_config_get(pc, cfg, val, cd);
}

/*
 * Variable:    bcm53540_phy drv
 * Purpose:     PHY Driver for BCM53540.
 */
phy_driver_t bcm53540_drv = {
    "bcm53540",
    "Internal Embedded Gigabit PHY Driver",  
    PHY_DRIVER_F_INTERNAL,
    bcm53540_phy_probe,                 /* pd_probe */
    bcm53540_phy_notify,                /* pd_notify */
    bcm53540_phy_reset,                 /* pd_reset */
    bcm53540_phy_init,                  /* pd_init */
    bcm53540_phy_link_get,              /* pd_link_get */
    bcm53540_phy_duplex_set,            /* pd_duplex_set */
    bcm53540_phy_duplex_get,            /* pd_duplex_get */
    bcm53540_phy_speed_set,             /* pd_speed_set */
    bcm53540_phy_speed_get,             /* pd_speed_get */
    bcm53540_phy_autoneg_set,           /* pd_autoneg_set */
    bcm53540_phy_autoneg_get,           /* pd_autoneg_get */
    bcm53540_phy_loopback_set,          /* pd_loopback_set */
    bcm53540_phy_loopback_get,          /* pd_loopback_get */
    bcm53540_phy_ability_get,           /* pd_ability_get */
    bcm53540_phy_config_set,            /* pd_config_set */
    bcm53540_phy_config_get,            /* pd_config_get */
    NULL,                               /* pd_status_get */
    NULL                                /* pd_cable_diag */
};
