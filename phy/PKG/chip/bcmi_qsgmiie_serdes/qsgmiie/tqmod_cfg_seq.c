...
int tqmod_tx_squelch_set(PHYMOD_ST *pc, int enable)
{
  ...
  PHYMOD_IF_ERR_RETURN(BCMI_QSGMIIE_SERDES_READ_TXFIR_MISC_CTL1r(pc, &tx_misc_ctl));
  BCMI_QSGMIIE_SERDES_TXFIR_MISC_CTL1r_SDK_TX_DISABLEf_SET(tx_misc_ctl, enable);
  PHYMOD_IF_ERR_RETURN(BCMI_QSGMIIE_SERDES_MODIFY_TXFIR_MISC_CTL1r(pc, tx_misc_ctl));
...
int tqmod_rx_squelch_set(PHYMOD_ST *pc, int enable)
{
  ...
  PHYMOD_IF_ERR_RETURN(BCMI_QSGMIIE_SERDES_READ_SIGDET_CTL1r(pc, &sigdet_ctl));
  if(enable){
  ...
  PHYMOD_IF_ERR_RETURN(BCMI_QSGMIIE_SERDES_MODIFY_SIGDET_CTL1r(pc, sigdet_ctl));
...
int tqmod_pcs_lane_swap (PHYMOD_ST* pc, int pcs_swap) {
  ...
  RXLNSWAPr_RX_LNSWAP_FORCE3f_SET(rxLnSwap, ((pcs_swap >> 6)& 3));
  RXLNSWAPr_RX_LNSWAP_FORCE2f_SET(rxLnSwap, ((pcs_swap >> 4)& 3));
  RXLNSWAPr_RX_LNSWAP_FORCE1f_SET(rxLnSwap, ((pcs_swap >> 2)& 3));
  RXLNSWAPr_RX_LNSWAP_FORCE0f_SET(rxLnSwap, ((pcs_swap >> 0)& 3));
  ...
  TXLNSWAPr_TX_LNSWAP_FORCE3f_SET(txLnSwap, ((pcs_swap >> 6)& 3));
  TXLNSWAPr_TX_LNSWAP_FORCE2f_SET(txLnSwap, ((pcs_swap >> 4)& 3));
  TXLNSWAPr_TX_LNSWAP_FORCE1f_SET(txLnSwap, ((pcs_swap >> 2)& 3));
  TXLNSWAPr_TX_LNSWAP_FORCE0f_SET(txLnSwap, ((pcs_swap >> 0)& 3));
