 ...
 *
 * PHY driver for BCM53101 integrated PHY.
 */

#include <phy/phy.h>
#include <phy/ge_phy.h>

#define BCM53101_PHY_ID0                 0x0362
#define BCM53101_PHY_ID1                 0x5ed0
 ...
 */
static int
bcm53101_phy_probe(phy_ctrl_t *pc)
{
    ...
    if (phyid0 == BCM53101_PHY_ID0 && 
        (phyid1 & ~PHY_ID1_REV_MASK) == BCM53101_PHY_ID1) {
 ...
 */
static int
bcm53101_phy_notify(phy_ctrl_t *pc, phy_event_t event)
{
    return CDK_E_NONE;
}
 ...
 */
static int
bcm53101_phy_reset(phy_ctrl_t *pc)
{
 ...
 */
static int
bcm53101_phy_init(phy_ctrl_t *pc)
{
    int ioerr = 0;
    ...
    /* EPHY initial setting for bcm53101 and bcm53280 */
 ...
 */
static int
bcm53101_phy_link_get(phy_ctrl_t *pc, int *link, int *autoneg_done)
{
 ...
 */
static int
bcm53101_phy_duplex_set(phy_ctrl_t *pc, int duplex)
{
 ...
 */
static int
bcm53101_phy_duplex_get(phy_ctrl_t *pc, int *duplex)
{
 ...
 */
static int
bcm53101_phy_speed_set(phy_ctrl_t *pc, uint32_t speed)
{
    int ret=0;
    int ioerr = 0;
    
    ret = ge_phy_speed_set(pc, speed);
    if (speed == 10) {
        ioerr += PHY_BUS_WRITE(pc, 0x1f, 0x8b);
        /* Power up RX block */
        ioerr += PHY_BUS_WRITE(pc, 0x14, 0x4000);
        PHY_SYS_USLEEP(1);
        /* Power down RX block */
        ioerr += PHY_BUS_WRITE(pc, 0x14, 0x0000);
        ioerr += PHY_BUS_WRITE(pc, 0x1f, 0xb);
    }
    return ioerr ? CDK_E_IO : ret;
}

/*
 * Function:    
 *      bcm53101_phy_speed_get
 * Purpose:     
 ...
 */
static int
bcm53101_phy_speed_get(phy_ctrl_t *pc, uint32_t *speed)
{
 ...
 */
static int
bcm53101_phy_autoneg_set(phy_ctrl_t *pc, int autoneg)
{
 ...
 */
static int
bcm53101_phy_autoneg_get(phy_ctrl_t *pc, int *autoneg)
{
 ...
 */
static int
bcm53101_phy_loopback_set(phy_ctrl_t *pc, int enable)
{
 ...
 */
static int
bcm53101_phy_loopback_get(phy_ctrl_t *pc, int *enable)
{
 ...
 */
static int
bcm53101_phy_ability_get(phy_ctrl_t *pc, uint32_t *abil)
{
    PHY_CTRL_CHECK(pc);
 ...
 */
static int
bcm53101_phy_config_set(phy_ctrl_t *pc, phy_config_t cfg, uint32_t val, void *cd)
{
    int ioerr = 0;
 ...
 */
static int
bcm53101_phy_config_get(phy_ctrl_t *pc, phy_config_t cfg, uint32_t *val, void *cd)
{
    int ioerr = 0;
    uint32_t misc_test;
...
/*
 * Variable:    bcm53101_phy drv
 * Purpose:     PHY Driver for BCM53101 integrated PHY.
 */
phy_driver_t bcm53101_drv = {
    "bcm53101",
    "BCM53101 Integrated Gigabit PHY Driver",  
    PHY_DRIVER_F_INTERNAL,
    bcm53101_phy_probe,                  /* pd_probe */
    bcm53101_phy_notify,                 /* pd_notify */
    bcm53101_phy_reset,                  /* pd_reset */
    bcm53101_phy_init,                   /* pd_init */
    bcm53101_phy_link_get,               /* pd_link_get */
    bcm53101_phy_duplex_set,             /* pd_duplex_set */
    bcm53101_phy_duplex_get,             /* pd_duplex_get */
    bcm53101_phy_speed_set,              /* pd_speed_set */
    bcm53101_phy_speed_get,              /* pd_speed_get */
    bcm53101_phy_autoneg_set,            /* pd_autoneg_set */
    bcm53101_phy_autoneg_get,            /* pd_autoneg_get */
    bcm53101_phy_loopback_set,           /* pd_loopback_set */
    bcm53101_phy_loopback_get,           /* pd_loopback_get */
    bcm53101_phy_ability_get,            /* pd_ability_get */
    bcm53101_phy_config_set,             /* pd_config_set */
    bcm53101_phy_config_get,             /* pd_config_get */
    NULL,                               /* pd_status_get */
    NULL                                /* pd_cable_diag */
};
