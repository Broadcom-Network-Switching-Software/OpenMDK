...
typedef enum {
  ...
  TEMOD_DIAG_DSC_STD         = 0x00010000 ,  /*!< DSC dump                                 */
  #if 0 
...
typedef enum {
  ...
  TEMOD_PLL_MODE_DIV_72      = 1   ,  /*!< Multiply ref. clk by 40         */
  ...
  TEMOD_PLL_MODE_DIV_50      = 5   ,  /*!< Multiply ref. clk by 50         */
  ...
  TEMOD_PLL_MODE_DIV_68      = 11  ,  /*!< Multiply ref. clk by 66         */
  ...
  TEMOD_PLL_MODE_DIV_100     = 15  ,  /*!< Multiply ref. clk by 10         */
  TEMOD_PLL_MODE_DIV_82P5    = 16  ,  /*!< Multiply ref. clk by 82.5         */
  TEMOD_PLL_MODE_DIV_87P5    = 17  ,  /*!< Multiply ref. clk by 87.5         */
  TEMOD_PLL_MODE_DIV_ILLEGAL         /*!< Illegal (programmatic boundary) */
} temod_pll_mode_type;

/*! \def CNT_temod_pll_mode_type Types of enum temod_pll_mode_type */
#define CNT_temod_pll_mode_type 19
