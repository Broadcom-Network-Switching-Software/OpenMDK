 ...
 *
 * PHY driver for BCM53010 integrated PHY.
 */
...
#define BCM53010_PHY_ID0                 0x600d
#define BCM53010_PHY_ID1                 0x8760
#define BCM53018_PHY_ID1                 0x87c0
 ...
 */
static int
bcm53010_phy_probe(phy_ctrl_t *pc)
{
    ...
    if ((phyid0 == BCM53010_PHY_ID0) && 
        ((phyid1 == BCM53010_PHY_ID1) || (phyid1 == BCM53018_PHY_ID1))) {
 ...
 */
static int
bcm53010_phy_notify(phy_ctrl_t *pc, phy_event_t event)
{
    return CDK_E_NONE;
}
 ...
 */
static int
bcm53010_phy_reset(phy_ctrl_t *pc)
{
 ...
 */
static int
bcm53010_phy_init(phy_ctrl_t *pc)
{
    int ioerr = 0;
 ...
 */
static int
bcm53010_phy_link_get(phy_ctrl_t *pc, int *link, int *autoneg_done)
{
 ...
 */
static int
bcm53010_phy_duplex_set(phy_ctrl_t *pc, int duplex)
{
 ...
 */
static int
bcm53010_phy_duplex_get(phy_ctrl_t *pc, int *duplex)
{
 ...
 */
static int
bcm53010_phy_speed_set(phy_ctrl_t *pc, uint32_t speed)
{
 ...
 */
static int
bcm53010_phy_speed_get(phy_ctrl_t *pc, uint32_t *speed)
{
 ...
 */
static int
bcm53010_phy_autoneg_set(phy_ctrl_t *pc, int autoneg)
{
 ...
 */
static int
bcm53010_phy_autoneg_get(phy_ctrl_t *pc, int *autoneg)
{
 ...
 */
static int
bcm53010_phy_loopback_set(phy_ctrl_t *pc, int enable)
{
 ...
 */
static int
bcm53010_phy_loopback_get(phy_ctrl_t *pc, int *enable)
{
 ...
 */
static int
bcm53010_phy_ability_get(phy_ctrl_t *pc, uint32_t *abil)
{
    PHY_CTRL_CHECK(pc);
 ...
 */
static int
bcm53010_phy_config_set(phy_ctrl_t *pc, phy_config_t cfg, uint32_t val, void *cd)
{
    int ioerr = 0;
    ...
    case PhyConfig_RemoteLoopback:
        /* Note : no match configuration with BMACSEC phy driver(phy53010) */
        if (val) {
 ...
 */
static int
bcm53010_phy_config_get(phy_ctrl_t *pc, phy_config_t cfg, uint32_t *val, void *cd)
{
    int ioerr = 0;
    uint32_t misc_test;
    uint32_t temp;
...
/*
 * Variable:    bcm53010_phy drv
 * Purpose:     PHY Driver for BCM53010 integrated PHY.
 */
phy_driver_t bcm53010_drv = {
    "bcm53010",
    "BCM53010 Integrated Gigabit PHY Driver",  
    PHY_DRIVER_F_INTERNAL,
    bcm53010_phy_probe,                  /* pd_probe */
    bcm53010_phy_notify,                 /* pd_notify */
    bcm53010_phy_reset,                  /* pd_reset */
    bcm53010_phy_init,                   /* pd_init */
    bcm53010_phy_link_get,               /* pd_link_get */
    bcm53010_phy_duplex_set,             /* pd_duplex_set */
    bcm53010_phy_duplex_get,             /* pd_duplex_get */
    bcm53010_phy_speed_set,              /* pd_speed_set */
    bcm53010_phy_speed_get,              /* pd_speed_get */
    bcm53010_phy_autoneg_set,            /* pd_autoneg_set */
    bcm53010_phy_autoneg_get,            /* pd_autoneg_get */
    bcm53010_phy_loopback_set,           /* pd_loopback_set */
    bcm53010_phy_loopback_get,           /* pd_loopback_get */
    bcm53010_phy_ability_get,            /* pd_ability_get */
    bcm53010_phy_config_set,             /* pd_config_set */
    bcm53010_phy_config_get,             /* pd_config_get */
    NULL,                               /* pd_status_get */
    NULL                                /* pd_cable_diag */
};
