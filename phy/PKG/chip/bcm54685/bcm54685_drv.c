 ...
 *
 * PHY driver for BCM54685.
 */

#include <phy/phy.h>
#include <phy/ge_phy.h>

#define BCM54685_PHY_ID0                0x0362
#define BCM54685_PHY_ID1                0x5db0

#define PHY_ID1_REV_MASK                0x000f

/* Default LED control */
#define BCM54685_LED1_SEL(_pc)          0x0
#define BCM54685_LED2_SEL(_pc)          0x1
#define BCM54685_LED3_SEL(_pc)          0x3
#define BCM54685_LED4_SEL(_pc)          0x6
#define BCM54685_LEDCTRL(_pc)           0x8
#define BCM54685_LEDSELECT(_pc)         0x0
 ...
 */
static int
bcm54685_phy_probe(phy_ctrl_t *pc)
{
    ...
    if (phyid0 == BCM54685_PHY_ID0 && 
        (phyid1 & ~PHY_ID1_REV_MASK) == BCM54685_PHY_ID1) {
 ...
 */
static int
bcm54685_phy_notify(phy_ctrl_t *pc, phy_event_t event)
{
    int rv = CDK_E_NONE;
 ...
 */
static int
bcm54685_phy_reset(phy_ctrl_t *pc)
{
    int rv;
 ...
 */
static int
bcm54685_phy_init(phy_ctrl_t *pc)
{
    int ioerr = 0;
 ...
 */
static int
bcm54685_phy_link_get(phy_ctrl_t *pc, int *link, int *autoneg_done)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
    int autoneg;
 ...
 */
static int
bcm54685_phy_duplex_set(phy_ctrl_t *pc, int duplex)
{
    int rv = CDK_E_NONE;
 ...
 */
static int
bcm54685_phy_duplex_get(phy_ctrl_t *pc, int *duplex)
{
    PHY_CTRL_CHECK(pc);
 ...
 */
static int
bcm54685_phy_speed_set(phy_ctrl_t *pc, uint32_t speed)
{
    int rv = CDK_E_NONE;
 ...
 */
static int
bcm54685_phy_speed_get(phy_ctrl_t *pc, uint32_t *speed)
{
    int rv;
    int autoneg, link;
 ...
 */
static int
bcm54685_phy_autoneg_set(phy_ctrl_t *pc, int autoneg)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
 ...
 */
static int
bcm54685_phy_autoneg_get(phy_ctrl_t *pc, int *autoneg)
{
 ...
 */
static int
bcm54685_phy_loopback_set(phy_ctrl_t *pc, int enable)
{
    PHY_CTRL_CHECK(pc);
 ...
 */
static int
bcm54685_phy_loopback_get(phy_ctrl_t *pc, int *enable)
{
    PHY_CTRL_CHECK(pc);
 ...
 */
static int
bcm54685_phy_ability_get(phy_ctrl_t *pc, uint32_t *abil)
{
    PHY_CTRL_CHECK(pc);
 ...
 */
static int
bcm54685_phy_config_set(phy_ctrl_t *pc, phy_config_t cfg, uint32_t val, void *cd)
{
    int ioerr = 0;
 ...
 */
static int
bcm54685_phy_config_get(phy_ctrl_t *pc, phy_config_t cfg, uint32_t *val, void *cd)
{
    int ioerr = 0;
    uint32_t sgmii_lb;
...
/*
 * Variable:    bcm54685_phy drv
 * Purpose:     PHY Driver for BCM54685.
 */
phy_driver_t bcm54685_drv = {
    "bcm54685",
    "BCM54685 Gigabit PHY Driver",  
    0,
    bcm54685_phy_probe,                 /* pd_probe */
    bcm54685_phy_notify,                /* pd_notify */
    bcm54685_phy_reset,                 /* pd_reset */
    bcm54685_phy_init,                  /* pd_init */
    bcm54685_phy_link_get,              /* pd_link_get */
    bcm54685_phy_duplex_set,            /* pd_duplex_set */
    bcm54685_phy_duplex_get,            /* pd_duplex_get */
    bcm54685_phy_speed_set,             /* pd_speed_set */
    bcm54685_phy_speed_get,             /* pd_speed_get */
    bcm54685_phy_autoneg_set,           /* pd_autoneg_set */
    bcm54685_phy_autoneg_get,           /* pd_autoneg_get */
    bcm54685_phy_loopback_set,          /* pd_loopback_set */
    bcm54685_phy_loopback_get,          /* pd_loopback_get */
    bcm54685_phy_ability_get,           /* pd_ability_get */
    bcm54685_phy_config_set,            /* pd_config_set */
    bcm54685_phy_config_get,            /* pd_config_get */
    NULL,                               /* pd_status_get */
    NULL                                /* pd_cable_diag */
};
