...
#ifndef _TSCE_DPLL_H__H_
#define _TSCE_DPLL_H__H_
...
/*Set\Get autoneg*/
int tsce_dpll_phy_autoneg_ability_set(const phymod_phy_access_t* phy, const phymod_autoneg_ability_t* an_ability_set_type);
