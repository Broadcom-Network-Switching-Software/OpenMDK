...
#ifndef __BCMI_WARPCORE3_XGXS_FIRMWARE_H__
#define __BCMI_WARPCORE3_XGXS_FIRMWARE_H__
...
extern uint8_t wc3_ucode_bin[];
extern unsigned int wc3_ucode_bin_len;

#endif /* __BCMI_WARPCORE3_XGXS_FIRMWARE_H__ */
