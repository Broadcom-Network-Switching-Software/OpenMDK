 ...
 */
static int
bcmi_unicore13g_serdes_lane(phy_ctrl_t *pc)
{
 ...
 */
static int
bcmi_unicore13g_serdes_stop(phy_ctrl_t *pc)
{
    int ioerr = 0;
    ...
    if ((PHY_CTRL_FLAGS(pc) & f_any) ||
        ...
        lane = bcmi_unicore13g_serdes_lane(pc);
 ...
 */
static int
bcmi_unicore13g_serdes_probe(phy_ctrl_t *pc)
{
 ...
 */
static int
bcmi_unicore13g_serdes_notify(phy_ctrl_t *pc, phy_event_t event)
{
    int ioerr = 0;
    ...
    bcmi_unicore13g_serdes_stop(pc);
 ...
 */
static int
bcmi_unicore13g_serdes_reset(phy_ctrl_t *pc)
{
    return CDK_E_NONE;
}
 ...
 */
static int
bcmi_unicore13g_serdes_init(phy_ctrl_t *pc)
{
    int ioerr = 0;
    int rv = CDK_E_NONE;
    ...
    READ_MISC3r(pc, &misc3);
    MISC3r_LANEDISABLEf_SET(misc3, 0);
    WRITE_MISC3r(pc, misc3);
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_link_get
 * Purpose:     
 ...
 */
static int
bcmi_unicore13g_serdes_link_get(phy_ctrl_t *pc, int *link, int *autoneg_done)
{
    int ioerr = 0;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_duplex_set
 * Purpose:     
 ...
 */
static int
bcmi_unicore13g_serdes_duplex_set(phy_ctrl_t *pc, int duplex)
{
    int ioerr = 0;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_duplex_get
 * Purpose:     
 ...
 */
static int
bcmi_unicore13g_serdes_duplex_get(phy_ctrl_t *pc, int *duplex)
{
    int ioerr = 0;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_speed_set
 * Purpose:     
 ...
 */
static int
bcmi_unicore13g_serdes_speed_set(phy_ctrl_t *pc, uint32_t speed)
{
    int ioerr = 0;
    int rv;
    int autoneg;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_speed_get
 * Purpose:     
...
static int
bcmi_unicore13g_serdes_speed_get(phy_ctrl_t *pc, uint32_t *speed)
{
    int ioerr = 0;
    uint32_t speed_mode;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_autoneg_set
 * Purpose:     
...
static int
bcmi_unicore13g_serdes_autoneg_set(phy_ctrl_t *pc, int autoneg)
{
    int ioerr = 0;
    MISC1r_t misc1;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_autoneg_get
 * Purpose:     
 ...
 */
static int
bcmi_unicore13g_serdes_autoneg_get(phy_ctrl_t *pc, int *autoneg)
{
    int ioerr = 0;
    COMBO_MIICNTLr_t mii_ctrl;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_loopback_set
 * Purpose:     
 ...
 */
static int
bcmi_unicore13g_serdes_loopback_set(phy_ctrl_t *pc, int enable)
{
    int ioerr = 0;
    COMBO_MIICNTLr_t mii_ctrl;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_loopback_get
 * Purpose:     
 ...
 */
static int
bcmi_unicore13g_serdes_loopback_get(phy_ctrl_t *pc, int *enable)
{
    int ioerr = 0;
    COMBO_MIICNTLr_t mii_ctrl;
...
/*
 * Function:    
 *      bcmi_unicore13g_serdes_ability_get
 * Purpose:     
 ...
 */
static int
bcmi_unicore13g_serdes_ability_get(phy_ctrl_t *pc, uint32_t *abil)
{
...
/*
 * Function:
 *      bcmi_unicore13g_serdes_config_set
 * Purpose:
 ...
 */
static int
bcmi_unicore13g_serdes_config_set(phy_ctrl_t *pc, phy_config_t cfg, uint32_t val, void *cd)
{
    PHY_CTRL_CHECK(pc);
    ...
    case PhyConfig_XauiTxPolInvert: {
        ...
        ioerr += READ_TX_ACONTROL_0r(pc, inst, &tx_ctrl);
        TX_ACONTROL_0r_TXPOL_FLIPf_SET(tx_ctrl, ((val) ? 1 : 0));
        ioerr += WRITE_TX_ACONTROL_0r(pc, inst, tx_ctrl);
        return ioerr ? CDK_E_IO : CDK_E_NONE;
    }
#endif
    ...
    case PhyConfig_XauiRxPolInvert: {
        int ioerr = 0;
        RX_CONTROL_PCIEr_t rx_ctrl;
        uint32_t inst = PHY_CTRL_INST(pc);
        int fval = (val) ? 1 : 0;
            
        ioerr += READ_RX_CONTROL_PCIEr(pc, inst, &rx_ctrl);
        RX_CONTROL_PCIEr_RX_POLARITY_FORCE_Rf_SET(rx_ctrl, fval);
        RX_CONTROL_PCIEr_RX_POLARITY_Rf_SET(rx_ctrl, fval);
        ioerr += WRITE_RX_CONTROL_PCIEr(pc, inst, rx_ctrl);
        return ioerr ? CDK_E_IO : CDK_E_NONE;
    }
#endif
...
/*
 * Function:
 *      bcmi_unicore13g_serdes_config_get
 * Purpose:
 ...
 */
static int
bcmi_unicore13g_serdes_config_get(phy_ctrl_t *pc, phy_config_t cfg, uint32_t *val, void *cd)
{
    PHY_CTRL_CHECK(pc);
...
phy_driver_t bcmi_unicore13g_serdes_drv = {
    "bcmi_unicore13g_serdes", 
    "Internal Unicore 13G SerDes PHY Driver",  
    PHY_DRIVER_F_INTERNAL,
    bcmi_unicore13g_serdes_probe,       /* pd_probe */
    bcmi_unicore13g_serdes_notify,      /* pd_notify */
    bcmi_unicore13g_serdes_reset,       /* pd_reset */
    bcmi_unicore13g_serdes_init,        /* pd_init */
    bcmi_unicore13g_serdes_link_get,    /* pd_link_get */
    bcmi_unicore13g_serdes_duplex_set,  /* pd_duplex_set */
    bcmi_unicore13g_serdes_duplex_get,  /* pd_duplex_get */
    bcmi_unicore13g_serdes_speed_set,   /* pd_speed_set */
    bcmi_unicore13g_serdes_speed_get,   /* pd_speed_get */
    bcmi_unicore13g_serdes_autoneg_set, /* pd_autoneg_set */
    bcmi_unicore13g_serdes_autoneg_get, /* pd_autoneg_get */
    bcmi_unicore13g_serdes_loopback_set,/* pd_loopback_set */
    bcmi_unicore13g_serdes_loopback_get,/* pd_loopback_get */
    bcmi_unicore13g_serdes_ability_get, /* pd_ability_get */
    bcmi_unicore13g_serdes_config_set,  /* pd_config_set */
    bcmi_unicore13g_serdes_config_get,  /* pd_config_get */
    NULL,                               /* pd_status_get */
    NULL                                /* pd_cable_diag */
};
