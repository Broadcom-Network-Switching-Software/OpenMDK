...
char* e2s_tefmod_gen3_lane_select_t [CNT_tefmod_gen3_lane_select_t] = {
  "TEFMOD_LANE_0_0_0_0" ,
  "TEFMOD_LANE_0_0_0_1" ,
  "TEFMOD_LANE_0_0_1_0" ,
  "TEFMOD_LANE_0_0_1_1" ,
  ...
  "TEFMOD_LANE_BCST" ,
  "TEFMOD_LANE_ILLEGAL" 
}; /* e2s_tefmod_gen3_lane_select_t */

int e2n_tefmod_gen3_lane_select_t [CNT_tefmod_gen3_lane_select_t] = {
  0 ,
  1 ,
  2 ,
  3 ,
  ...
  15 ,
  0 
}; /* e2n_tefmod_gen3_lane_select_t */

char* e2s_tefmod_gen3_spd_intfc_type_t [CNT_tefmod_gen3_spd_intfc_type_t] = {
  "TEFMOD_SPD_ZERO" ,
  "TEFMOD_SPD_10_SGMII" ,
  ...
  "TEFMOD_SPD_5G_KR1" ,
  "TEFMOD_SPD_ILLEGAL" 
}; /* e2s_tefmod_gen3_spd_intfc_type_t */

int e2n_tefmod_gen3_spd_intfc_type_t [CNT_tefmod_gen3_spd_intfc_type_t] = {
  0 ,
  10 ,
  100 ,
  1000 ,
  ...
  10000 ,
  0 
}; /* e2n_tefmod_gen3_spd_intfc_type_t */

char* e2s_tefmod_gen3_regacc_type_t [CNT_tefmod_gen3_regacc_type_t] = {
...
}; /* e2s_tefmod_gen3_regacc_type_t */

char* e2s_tefmod_gen3_port_type_t [CNT_tefmod_gen3_port_type_t] = {
...
}; /* e2s_tefmod_gen3_port_type_t */

char* e2s_tefmod_gen3_sc_mode_type_t [CNT_tefmod_gen3_sc_mode_type_t] = {
...
}; /* e2s_tefmod_gen3_sc_mode_type_t */

char* e2s_tefmod_gen3_diag_type_t [CNT_tefmod_gen3_diag_type_t] = {
...
}; /* e2s_tefmod_gen3_diag_type_t */

char* e2s_tefmod_gen3_model_type_t [CNT_tefmod_gen3_model_type_t] = {
  "TEFMOD_GEN3_WC" ,
  "TEFMOD_GEN3_WC_A0" ,
  "TEFMOD_GEN3_WC_A1" ,
  "TEFMOD_GEN3_WC_A2" ,
...
}; /* e2s_tefmod_gen3_model_type_t */

char* e2s_tefmod_gen3_an_type_t [CNT_tefmod_gen3_an_type_t] = {
  "TEFMOD_AN_CL73" ,
  "TEFMOD_AN_CL73_BAM" ,
  "TEFMOD_AN_HPAM" ,
  "TEFMOD_AN_MSA" ,
...
}; /* e2s_tefmod_gen3_an_type_t */

char* e2s_tefmod_gen3_eye_direction_t [CNT_tefmod_gen3_eye_direction_t] = {
  "TEFMOD_EYE_VU" ,
  "TEFMOD_EYE_VD" ,
  "TEFMOD_EYE_HL" ,
  "TEFMOD_EYE_HR" ,
  "TEFMOD_EYE_ILLEGAL" 
}; /* e2s_tefmod_gen3_eye_direction_t */

char* e2s_tefmod_gen3_aspd_type_t [CNT_tefmod_gen3_aspd_type_t] = {
  "TEFMOD_ASPD_10M" ,
  "TEFMOD_ASPD_100M" ,
  "TEFMOD_ASPD_1000M" ,
  "TEFMOD_ASPD_2p5G_X1" ,
...
}; /* e2s_tefmod_gen3_aspd_type_t */

int e2n_tefmod_gen3_aspd_type_t [CNT_tefmod_gen3_aspd_type_t] = {
  0x0 ,
  0x1 ,
  0x2 ,
  0x3 ,
  ...
  0x3a ,
  0xff 
}; /* e2n_tefmod_gen3_aspd_type_t */

char* e2s_tefmod_gen3_tech_ability_t [CNT_tefmod_gen3_tech_ability_t] = {
  "TEFMOD_ABILITY_1G" ,
...
}; /* e2s_tefmod_gen3_tech_ability_t */

int e2n_tefmod_gen3_tech_ability_t [CNT_tefmod_gen3_tech_ability_t] = {
  0x6 ,
  0x7 ,
  0x8 ,
  0x9 ,
  ...
  0x508 ,
  0x999 
}; /* e2n_tefmod_gen3_tech_ability_t */


char* e2s_tefmod_gen3_diag_an_type_t [CNT_tefmod_gen3_diag_an_type_t] = {
  "TEFMOD_DIAG_AN_DONE" ,
  "TEFMOD_DIAG_AN_HCD" ,
  "TEFMOD_DIAG_AN_TYPE_ILLEGAL" 
}; /* e2s_tefmod_gen3_diag_an_type_t */

char* e2s_tefmod_gen3_tier1_function_type_t [CNT_tefmod_gen3_tier1_function_type_t] = {
  "PCS_BYPASS_CTL" ,
  "CREDIT_SET" ,
  "ENCODE_SET" ,
  "DECODE_SET" ,
...
}; /* e2s_tefmod_gen3_tier1_function_type_t */

char* e2s_tefmod_gen3_fec_en_parm_t [CNT_tefmod_gen3_fec_en_parm_t] = {
...
}; /* e2s_tefmod_gen3_fec_en_parm_t */

char* e2s_tefmod_gen3_fec_type_t [CNT_tefmod_gen3_fec_type_t] = {
  "TEFMOD_CL74" ,
  "TEFMOD_CL91" 
}; /* e2s_tefmod_gen3_fec_type_t */


char* e2s_tefmod_gen3_tx_disable_enum_t [CNT_tefmod_gen3_tx_disable_enum_t] = {
  "TEFMOD_GEN3_TX_LANE_TRAFFIC" ,
  "TEFMOD_GEN3_TX_LANE_RESET" 
}; /* e2s_tefmod_gen3_tx_disable_enum_t */

char* e2s_tefmod_gen3_os_mode_type [CNT_tefmod_gen3_os_mode_type] = {
...
}; /* e2s_tefmod_gen3_os_mode_type */

int e2n_tefmod_gen3_os_mode_type [CNT_tefmod_gen3_os_mode_type] = {
  1 ,
  2 ,
  4 ,
  16 ,
  10 ,
  0 
}; /* e2n_tefmod_gen3_os_mode_type */

char* e2s_tefmod_gen3_scr_mode [CNT_tefmod_gen3_scr_mode] = {
...
}; /* e2s_tefmod_gen3_scr_mode */

int e2n_tefmod_gen3_scr_mode [CNT_tefmod_gen3_scr_mode] = {
  0 ,
  1 ,
  2 ,
  3 ,
  ...
  5 ,
  0 
}; /* e2n_tefmod_gen3_scr_mode */

char* e2s_tefmod_gen3_encode_mode [CNT_tefmod_gen3_encode_mode] = {
  "TEFMOD_ENCODE_MODE_NONE" ,
  "TEFMOD_ENCODE_MODE_CL49" ,
  "TEFMOD_ENCODE_MODE_CL82" ,
  "TEFMOD_ENCODE_MODE_ILLEGAL" 
}; /* e2s_tefmod_gen3_encode_mode */

int e2n_tefmod_gen3_encode_mode [CNT_tefmod_gen3_encode_mode] = {
  0 ,
  1 ,
  2 ,
  15 
}; /* e2n_tefmod_gen3_encode_mode */

char* e2s_tefmod_gen3_descrambler_mode [CNT_tefmod_gen3_descrambler_mode] = {
  "TEFMOD_R_DESCR_MODE_BYPASS" ,
  "TEFMOD_R_DESCR_MODE_CL49" ,
  "TEFMOD_R_DESCR_MODE_CL82" ,
  "TEFMOD_R_DESCR_MODE_ILLEGAL" 
}; /* e2s_tefmod_gen3_descrambler_mode */

char* e2s_tefmod_gen3_dec_tl_mode [CNT_tefmod_gen3_dec_tl_mode] = {
  "TEFMOD_DEC_TL_MODE_NONE" ,
  "TEFMOD_DEC_TL_MODE_CL49" ,
  "TEFMOD_DEC_TL_MODE_CL82" ,
  "TEFMOD_DEC_TL_MODE_ILLEGAL" 
}; /* e2s_tefmod_gen3_dec_tl_mode */

char* e2s_tefmod_gen3_dec_fsm_mode [CNT_tefmod_gen3_dec_fsm_mode] = {
  "TEFMOD_DEC_FSM_MODE_NONE" ,
  "TEFMOD_DEC_FSM_MODE_CL49" ,
  "TEFMOD_DEC_FSM_MODE_CL82" ,
  "TEFMOD_DEC_FSM_MODE_ILLEGAL" 
}; /* e2s_tefmod_gen3_dec_fsm_mode */

char* e2s_tefmod_gen3_deskew_mode [CNT_tefmod_gen3_deskew_mode] = {
...
}; /* e2s_tefmod_gen3_deskew_mode */

char* e2s_tefmod_gen3_t_fifo_mode [CNT_tefmod_gen3_t_fifo_mode] = {
  "TEFMOD_T_FIFO_MODE_NONE" ,
  "TEFMOD_T_FIFO_MODE_40G" ,
  "TEFMOD_T_FIFO_MODE_100G" ,
  "TEFMOD_T_FIFO_MODE_20G" ,
  "TEFMOD_T_FIFO_MODE_ILLEGAL" 
}; /* e2s_tefmod_gen3_t_fifo_mode */

char* e2s_tefmod_gen3_bs_btmx_mode [CNT_tefmod_gen3_bs_btmx_mode] = {
...
}; /* e2s_tefmod_gen3_bs_btmx_mode */

char* e2s_tefmod_gen3_bs_dist_mode [CNT_tefmod_gen3_bs_dist_mode] = {
