...
***********************************************************************************
*                                                                                 *
*  Revision    :  $Id: falcon2_monterey_interface.h 1560 Broadcom SDK $   *
*                                                                                 *
 ...
 * (http://ingbu.broadcom.com/hsip/falcon2_monterey/SerDes%20Documents/PMD_Methodology/Serdes%20External%20Micro%20User%20Guide.docx)
 * \n \n
 *
 * \section API_sec Important API Files
 *
 * falcon2_monterey_interface.h - provides the primary functionality.
 *
 * falcon2_monterey_dependencies.h - defines the functions to be provided by the IP user
 *
 * \n \n
 * Copyright 2014 Broadcom Corporation all rights reserved
 */

/** @file falcon2_monterey_interface.h
 * Main interface functions provided to IP User
 */

#ifndef FALCON2_MONTEREY_API_INTERFACE_H
#define FALCON2_MONTEREY_API_INTERFACE_H
...
struct falcon2_monterey_uc_lane_config_field_st {
...
struct falcon2_monterey_uc_core_config_field_st {
	uint8_t vco_rate;
...
/** Lane Config Struct */
struct  falcon2_monterey_uc_lane_config_st {
	struct falcon2_monterey_uc_lane_config_field_st field;
	uint16_t word;
};

/** Core Config Struct */
struct  falcon2_monterey_uc_core_config_st {
	struct falcon2_monterey_uc_core_config_field_st field;
	uint16_t word;
	int vco_rate_in_Mhz; /* if >0 then will get converted and replace field.vco_rate when update is called */
};

/** Eyescan Options Struct */
struct falcon2_monterey_eyescan_options_st {
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_monterey_get_uc_core_config (const phymod_access_t *pa, struct falcon2_monterey_uc_core_config_st *struct_val);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_monterey_display_core_config (const phymod_access_t *pa);
...
/** Column definition header for falcon2_monterey_display_core_state() API output.
 * To be called before falcon2_monterey_display_core_state_line() API.
 * @param pa phymod_access_t struct
 ...
 * Call falcon2_monterey_display_core_state_hdr() API before and falcon2_monterey_display_core_state_legend() after
...
/** Detailed description of each column in falcon2_monterey_display_core_state_line() API output.
 * To be called after falcon2_monterey_display_core_state_line() API to display the legends.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * \n Note: Micro should be loaded only after issuing a falcon2_monterey_uc_reset(1) followed by asserting and de-asserting
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [falcon2_monterey_ucode_crc_verify()] and verifying the CRC value [falcon2_monterey_start_ucode_crc_calc()].
 * @param pa phymod_access_t struct
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [falcon2_monterey_ucode_crc_verify()] and verifying the CRC value [falcon2_monterey_start_ucode_crc_calc()].
 * @param pa phymod_access_t struct
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * Note: falcon2_monterey_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane.
 * @param pa phymod_access_t struct
 ...
 * Note: User also needs to configure all lanes through falcon2_monterey_lane_config_for_iddq()
 ...
 * Along with falcon2_monterey_core_pwrdn(), all lanes powerdowns should also be issued using
 * falcon2_monterey_lane_pwrdn() to complete a Core Powerdown.
 * @param pa phymod_access_t struct
 * @param mode based on enum #srds_core_pwrdn_mode_enum select from ON, CORE, DEEP power down modes
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_monterey_core_pwrdn (const phymod_access_t *pa, enum srds_core_pwrdn_mode_enum mode);
 ...
 * If using MDIO interface to access the registers, use this API to implement falcon2_monterey_pmd_mwr_reg().
 * @param pa phymod_access_t struct
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_monterey_get_uc_lane_cfg (const phymod_access_t *pa, struct falcon2_monterey_uc_lane_config_st *struct_val);
 ...
 * It relies on the accuracy of falcon2_monterey_delay_us() function. \n\n
 ...
 * This function only initiates the processor actions.  User must use falcon2_monterey_read_eye_scan_stripe() function
 ...
 * falcon2_monterey_start_ber_scan_test(), falcon2_monterey_read_ber_scan_data(), falcon2_monterey_display_ber_scan_data().
 *
 * @param pa phymod_access_t struct
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 ...
 * \n Note: Call functions falcon2_monterey_display_lane_state_hdr() before and falcon2_monterey_display_lane_state_legend() after
...
/** Column definition header for falcon2_monterey display state.
 * To be called before falcon2_monterey_display_lane_state() function.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon2_monterey_display_lane_state_hdr (const phymod_access_t *pa);

/** Detailed explanation of each column in falcon2_monterey display state.
 * To be called after falcon2_monterey_display_lane_state() function to display the legends.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable falcon2_monterey support.
 * @param pa phymod_access_t struct
...
/** Parameterized diagnostic function which access to all falcon2_monterey control and status bits
 * This function is required to be implemented by upper level software to enable falcon2_monterey support.
 * @param pa phymod_access_t struct
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the falcon2_monterey_stop_rx_adaptation() API.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: The patt_length input to the function should be the value sent to the falcon2_monterey_config_shared_tx_pattern() function
 * @param pa phymod_access_t struct
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in falcon2_monterey_config_shared_tx_pattern()
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Once the PRBS generator is configured, to enable PRBS use the falcon2_monterey_tx_prbs_en() API.
 * @param pa phymod_access_t struct
 ...
 * Once the PRBS checker is configured, use the falcon2_monterey_rx_prbs_en() API to enable the checker.
 * @param pa phymod_access_t struct
 ...
 * Note: User needs to configure all lanes through falcon2_monterey_lane_config_for_iddq() and also call falcon2_monterey_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * If you want loop timing use falcon2_monterey_rmt_lpbk()
 * @param pa phymod_access_t struct
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function should be called prior to falcon2_monterey_rptr_mode_timing();
 * @param pa phymod_access_t struct
 * @param enable Enable/Disable (1 = Enable; 0 = Disable)
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
