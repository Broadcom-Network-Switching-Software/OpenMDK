...
extern uint8_t tefmod_gen3_pll_idx_get(PHYMOD_ST *pc);
...
#if 0
extern int tefmod_gen3_set_speed_id(PHYMOD_ST *pc, int speed_id);
extern int tefmod_gen3_setup_for_sw_an(PHYMOD_ST* pc, int num_lanes);
extern int tefmod_gen3_pxgng_status_an_ack_complete_get(PHYMOD_ST *pc, int *ack_complte);
extern int tefmod_gen3_pxgng_status_an_good_chk_get(PHYMOD_ST *pc, uint8_t *an_good_chk);
#else
extern int tefmod_gen3_set_speed_id(PHYMOD_ST *pc, int speed_id);
extern int tefmod_gen3_pxgng_status_an_ack_complete_get(PHYMOD_ST *pc, int *ack_complte);
extern int tefmod_gen3_pxgng_status_an_good_chk_get(PHYMOD_ST *pc, uint8_t *an_good_chk);
