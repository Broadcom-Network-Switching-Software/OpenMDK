...
**********************************************************************************
*                                                                                *
*  Revision    :  $Id: eagle2_tsc2pll_internal.h 1457 Broadcom SDK $ *
*                                                                                *
...
/** @file eagle2_tsc2pll_internal.h
 * Internal API functions
 */

#ifndef EAGLE2_TSC2PLL_API_INTERNAL_H
#define EAGLE2_TSC2PLL_API_INTERNAL_H
 ...
 * as part of eagle2_tsc2pll_display_core_state_line()
 * @param pa phymod_access_t struct
...
/*-----------------------------*/
/** Read current eagle2_tsc2pll core status.
 * @param pa phymod_access_t struct
 * @param *istate Current eagle2_tsc2pll core status read back and populated by the API
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
static err_code_t _eagle2_tsc2pll_display_core_state_no_newline (const phymod_access_t *pa);

/*-----------------------------*/
/*  Read / Display Lane state  */
/*-----------------------------*/
/** Read current eagle2_tsc2pll lane status.
 * @param pa phymod_access_t struct
 * @param *istate Current eagle2_tsc2pll lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param pa phymod_access_t struct
 * @param *pll_lock Current eagle2_tsc2pll lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current eagle2_tsc2pll lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param pa phymod_access_t struct
 * @param *pmd_lock Current eagle2_tsc2pll lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current eagle2_tsc2pll lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param pa phymod_access_t struct
 * @param *sig_det Current eagle2_tsc2pll lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current eagle2_tsc2pll lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
SDK_STATIC err_code_t _eagle2_tsc2pll_get_osr_mode (const phymod_access_t *pa, eagle2_tsc2pll_osr_mode_st *mode);
 ...
 * Along with eagle2_tsc2pll_core_clkgate(), all lanes should also be clock gated using eagle2_tsc2pll_lane_clkgate() to complete a Core Clockgate
 * @param pa phymod_access_t struct
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in eagle2_tsc2pll_functions.c.
 *
 * @param pa phymod_access_t struct
