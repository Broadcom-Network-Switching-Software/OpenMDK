...
*  Revision      :  $Id: eagle2_tsc2pll_functions.c 1490 Broadcom SDK $ *
*                                                                                 *
...
err_code_t eagle2_tsc2pll_display_diag_data (const phymod_access_t *pa, uint16_t diag_level){
...
err_code_t eagle2_tsc2pll_event_log_stop (const phymod_access_t *pa){
	...
	EFUN(eagle2_tsc2pll_pmd_uc_cmd (pa, CMD_EVENT_LOG_READ, CMD_EVENT_LOG_READ_START, 10));
...
err_code_t eagle2_tsc2pll_event_log_readmem (const phymod_access_t *pa, uint8_t *trace_mem){
	...
	do {
		/* Read Next */
		EFUN(eagle2_tsc2pll_pmd_uc_cmd (pa, CMD_EVENT_LOG_READ, CMD_EVENT_LOG_READ_NEXT, 10));
	...
	EFUN(eagle2_tsc2pll_pmd_uc_cmd (pa, CMD_EVENT_LOG_READ, CMD_EVENT_LOG_READ_DONE, 10));
