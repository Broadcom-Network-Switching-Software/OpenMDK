 ...
 *  $Id: e475728536c0cbff4c168e2add6e30ceed1388db $
*/
...
#include <phy/chip/bcmi_sgmiip2x4_serdes_defs.h>
...
static int _sgmiip2x4_global_loopback_set (const PHYMOD_ST *pa, uint8_t enable)
{
    ...
    SP2_LANECTLr_GLOOP1Gf_SET(lanectlr, enable);
    ...
    SP2_RX_AFE_CTL1r_DEMUX_PEAK_PDf_SET(ctl1r, 1);
    SP2_RX_AFE_CTL1r_DEMUX_ZERO_PDf_SET(ctl1r, 1);
...
int viper_xgxs_sel(const PHYMOD_ST *pa, int xgxs_select)
{
...
int viper_diag_topology(PHYMOD_ST *pa)
{
     ...
     int value = 0, div_tmp = 0, os_mode = 0, lane = 0, mask= 0;
     uint32_t vco= 0;
     char *mode;
    ...
    div_tmp = (value == 1)? 40 : 32;
    vco = 156 * div_tmp + 25 * div_tmp/100;
    DIG_MISC8r_CLR(misc8);
