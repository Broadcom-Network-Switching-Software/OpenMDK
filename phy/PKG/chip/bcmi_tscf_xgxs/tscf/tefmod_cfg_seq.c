...
int tefmod_an_oui_set(PHYMOD_ST* pc, tefmod_an_oui_t oui) 
{
  ...
  /* FOR TH+ family of switches*/
  if (model == TSCF_GEN2) {
    AN_X1_OUI_LWR_GEN2r_t  AN_X1_CONTROL_OUI_LOWER_GEN2r_reg;
    AN_X1_OUI_UPR_GEN2r_t   AN_X1_CONTROL_OUI_UPPER_GEN2r_reg;
    AN_X4_CL73_CTLS_GEN2r_t  AN_X4_CL73_CTLS_GEN2r_t_reg;

    AN_X1_OUI_LWR_GEN2r_CLR(AN_X1_CONTROL_OUI_LOWER_GEN2r_reg);
    AN_X1_OUI_LWR_GEN2r_SET(AN_X1_CONTROL_OUI_LOWER_GEN2r_reg, oui.oui & 0xffff);

    /********Setting AN_X1_OUI_LWR 0x9241*****/
    PHYMOD_IF_ERR_RETURN(WRITE_AN_X1_OUI_LWR_GEN2r(pc, AN_X1_CONTROL_OUI_LOWER_GEN2r_reg));
    AN_X1_OUI_UPR_GEN2r_CLR(AN_X1_CONTROL_OUI_UPPER_GEN2r_reg);
    AN_X1_OUI_UPR_GEN2r_SET(AN_X1_CONTROL_OUI_UPPER_GEN2r_reg, (oui.oui >> 16) & 0xff);

    /********Setting AN_X1_OUI_UPR 0x9240*****/
    PHYMOD_IF_ERR_RETURN(WRITE_AN_X1_OUI_UPR_GEN2r(pc, AN_X1_CONTROL_OUI_UPPER_GEN2r_reg));
    AN_X4_CL73_CTLS_GEN2r_CLR(AN_X4_CL73_CTLS_GEN2r_t_reg);
    AN_X4_CL73_CTLS_GEN2r_AN_OUI_OVERRIDE_BAM73_ADVf_SET(AN_X4_CL73_CTLS_GEN2r_t_reg, oui.oui_override_bam73_adv);
    AN_X4_CL73_CTLS_GEN2r_AN_OUI_OVERRIDE_BAM73_DETf_SET(AN_X4_CL73_CTLS_GEN2r_t_reg, oui.oui_override_bam73_det);
...
int tefmod_an_oui_get(PHYMOD_ST* pc, tefmod_an_oui_t* oui) {
  ...
  if (model == TSCF_GEN2) {
    ...
    PHYMOD_IF_ERR_RETURN(READ_AN_X1_OUI_LWR_GEN2r(pc, &AN_X1_CONTROL_OUI_LOWER_GEN2r_reg));
    PHYMOD_IF_ERR_RETURN(READ_AN_X1_OUI_UPR_GEN2r(pc, &AN_X1_CONTROL_OUI_UPPER_GEN2r_reg));
    PHYMOD_IF_ERR_RETURN(READ_AN_X4_CL73_CTLS_GEN2r(pc, &AN_X4_CL73_CTLS_GEN2r_t_reg));

    oui->oui  = AN_X1_OUI_LWR_GEN2r_GET(AN_X1_CONTROL_OUI_LOWER_GEN2r_reg);
    oui->oui |= ((AN_X1_OUI_UPR_GEN2r_GET(AN_X1_CONTROL_OUI_UPPER_GEN2r_reg)) << 16);

    oui->oui_override_bam73_adv = AN_X4_CL73_CTLS_GEN2r_AN_OUI_OVERRIDE_BAM73_ADVf_GET(AN_X4_CL73_CTLS_GEN2r_t_reg);
    oui->oui_override_bam73_det = AN_X4_CL73_CTLS_GEN2r_AN_OUI_OVERRIDE_BAM73_DETf_GET(AN_X4_CL73_CTLS_GEN2r_t_reg);
...
int tefmod_sw_an_advert_set(PHYMOD_ST* pc, tefmod_an_adv_ability_t *cl73_adv, phymod_sw_an_ctxt_t *an_ctxt) 
{
    ...
    /* need to generate a 5 bit random number for Tx nounce for now set to 1 */
    an_ctxt->tx_pages.base_page.page_1 |= ((AN_BASE1_PAGE_TX_NOUNCE_MASK & 0x7fff)  <<
                                            AN_BASE1_PAGE_TX_NOUNCE_OFFSET);
#endif
...
int tefmod_25g_rsfec_am_init(PHYMOD_ST *pc) 
{
    ...
    /* MSA Mode Program AM0 value to use 100G AM  AM123 should use 40G AM 
     * which is a default 
     */
    PHYMOD_IF_ERR_RETURN(
        READ_SC_X4_MSA_25G_50G_CTL_GEN2r(pc, &msa_25g_50g_am_reg));
    SC_X4_MSA_25G_50G_CTL_GEN2r_MSA_50G_AM0_FORMATf_SET(msa_25g_50g_am_reg, 1);
