...
#if defined(CDK_CONFIG_INCLUDE_BCM56260_A0) && CDK_CONFIG_INCLUDE_BCM56260_A0 == 1
...
{
    if (port >= 25) {
        return 0x1 + CDK_XGSD_MIIM_IBUS(1);
    }
    if (port >= 21) {
        return 0x15 + CDK_XGSD_MIIM_IBUS(0);
    }
    if (port >= 17) {
        return 0x11 + CDK_XGSD_MIIM_IBUS(0);
    } 
    if (port >= 13) {
        return 0xd + CDK_XGSD_MIIM_IBUS(0);
    } 
    if (port >= 9) {
        return 0x9 + CDK_XGSD_MIIM_IBUS(0);
    }        
    if (port >= 5) {
        return 0x5 + CDK_XGSD_MIIM_IBUS(0);
    }
    return 0x1 + CDK_XGSD_MIIM_IBUS(0);
}
...
phy_bus_t phy_bus_bcm56260_miim_int = {
    "bcm56260_miim_int",
    _phy_addr,
    _read,
    _write,
...
int bcm56260_miim_int_not_empty;
