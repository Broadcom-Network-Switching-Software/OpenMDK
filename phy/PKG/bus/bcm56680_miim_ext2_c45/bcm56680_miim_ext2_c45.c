 ...
 *
 * BCM56624 PHY access functions for external bus 2 using clause 45.
 */
...
_phy_addr(int port)
{
    return port - 28 + 1 + CDK_XGS_MIIM_BUS_2;
}
...
phy_bus_t phy_bus_bcm56680_miim_ext2_c45 = {
    "bcm56680_miim_ext2_c45",
    _phy_addr,
    _read,
    _write
};
...
int bcm56680_miim_ext2_c45_not_empty;
