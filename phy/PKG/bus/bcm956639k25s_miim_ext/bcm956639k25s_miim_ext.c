...
_phy_addr(int port)
{
    if (port == 1) {
        ...
        return port - 26 + CDK_XGS_MIIM_BUS_2;
    } else if (port == 30) {
        return 4 + CDK_XGS_MIIM_BUS_2;
    } else if (port == 38) {
...
phy_bus_t phy_bus_bcm956639k25s_miim_ext = {
    "bcm956639k25s_miim_ext",
    _phy_addr,
    _read,
    _write
};
...
int bcm956639k25s_miim_int_not_empty;
