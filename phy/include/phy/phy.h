 ...
 * PHY Master Modes
 */
#define PHY_MS_NONE             0
#define PHY_MS_SLAVE            1
#define PHY_MS_MASTER           2
#define PHY_MS_AUTO             3
...
typedef enum {
    ...
    PhyConfig_PHY_SERDES,       /* Mac-side speed assigned */
    PhyConfig_Clause37En,       /* Clause 37 enabled */
    PhyConfig_Clause73En,       /* Clause 73 enabled */
    PhyConfig_Ability2,         /* Ability2 */
    PhyConfig_AdvLocal2,        /* PHY_ABIL2_xxx */
    PhyConfig_AdvRemote2,       /* PHY_ABIL2_xxx (read-only) */
...
/* PHY abilities2, it's the extention from PHY ability with PHY_ABIL_NEXT */
#define PHY_ABIL2_5000MB        (1L << 0)
#define PHY_ABIL2_3000MB        (1L << 1)

/* EEE Abilities */
#define PHY_ABIL_EEE_100MB      (1L << 0)
#define PHY_ABIL_EEE_1GB        (1L << 1)
#define PHY_ABIL_EEE_10GB       (1L << 2)
#define PHY_ABIL_EEE_10GB_KX    (1L << 3)
#define PHY_ABIL_EEE_10GB_KX4   (1L << 4)
#define PHY_ABIL_EEE_10GB_KR    (1L << 5)
...
#define PHY_F_CLAUSE73          (1L << 25)
#define PHY_F_CLAUSE37          (1L << 26)
#define PHY_F_PRIVATE           (1L << 30)
#define PHY_F_ADDR_VALID        (1L << 31)

/* PHY bus capability */
#define PHY_BUS_CAP_WR_MASK     (1L << 0)
...
typedef struct phy_bus_s {
    ...
    /* Get the phy bus capability */
    uint32_t (*bus_cap)(uint32_t addr);
...
#define PHY_BUS_CAP(_pc) \
        ((_pc->bus->bus_cap) ? _pc->bus->bus_cap(PHY_CTRL_BUS_ADDR(pc)) : 0)
