...
extern int cdk_shcmd_cdk(int argc, char *argv[]);

#define CDK_SHCMD_CDK_DESC     "Show CDK configuration"
#define CDK_SHCMD_CDK_SYNOP \
"[0|1] [[!]substr]"
#define CDK_SHCMD_CDK_HELP \
"Display the values of the CDK configuration variables for the current\n" \
