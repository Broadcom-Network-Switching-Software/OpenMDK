...
#define CDK_DEV_MBUS_AXI        0x00000800
...
#define CDK_DCFG_PORT_F_OVERSUB         0x00000002
#define CDK_DCFG_PORT_F_PASSTHRU        0x00000004
    uint32_t port_flags;
...
#define CDK_PORT_CONFIG_NUM_LANES(_u,_p) cdk_dev_num_lanes_get(_u,_p)
