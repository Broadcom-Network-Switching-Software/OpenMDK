...
static cdk_xgsd_chip_info_t bcm56162_a0_chip_info = {
    ...
    BCM56160_A0_CHIP_FLAG_FREQ111 |
    BCM56160_A0_CHIP_FLAG_TSC13G |
    0,
...
extern int
bcm56162_a0_setup(cdk_dev_t *dev);

int
bcm56162_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56162_a0_chip_info;
