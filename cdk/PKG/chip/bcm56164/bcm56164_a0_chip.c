...
static cdk_xgsd_chip_info_t bcm56164_a0_chip_info = {
    ...
    CDK_PBMP_2(0xfffffc01, 0x0000003f),

    /* Chip flags */
    CDK_XGSD_CHIP_FLAG_IPROC |
    BCM56160_A0_CHIP_FLAG_FREQ75 |
    BCM56160_A0_CHIP_FLAG_NO_TSC1 |
...
extern int
bcm56164_a0_setup(cdk_dev_t *dev);

int
bcm56164_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56164_a0_chip_info;
