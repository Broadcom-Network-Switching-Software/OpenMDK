...
/* Block types */
const char *bcm56334_b0_blktype_names[] = {
    "cmic",
    "epipe",
    "gport",
    "ipipe",
...
/* Block structures */
cdk_xgs_block_t bcm56334_b0_blocks[] = 
{
    { BCM56334_B0_BLKTYPE_GPORT,        2,      CDK_PBMP_1(0x000003fc) },
    { BCM56334_B0_BLKTYPE_GPORT,        3,      CDK_PBMP_1(0x0003fc00) },
    { BCM56334_B0_BLKTYPE_GPORT,        4,      CDK_PBMP_1(0x03fc0000) },
    { BCM56334_B0_BLKTYPE_XQPORT,       5,      CDK_PBMP_1(0x04000000) },
    { BCM56334_B0_BLKTYPE_XQPORT,       6,      CDK_PBMP_1(0x08000000) },
    { BCM56334_B0_BLKTYPE_XQPORT,       7,      CDK_PBMP_1(0x10000000) },
    { BCM56334_B0_BLKTYPE_XQPORT,       8,      CDK_PBMP_1(0x20000000) },
    { BCM56334_B0_BLKTYPE_IPIPE,        10,     CDK_PBMP_1(0x3fffffff) },
    { BCM56334_B0_BLKTYPE_EPIPE,        11,     CDK_PBMP_1(0x3fffffff) },
    { BCM56334_B0_BLKTYPE_MMU,          12,     CDK_PBMP_1(0x3fffffff) }
};
...
cdk_xgs_numel_info_t bcm56334_b0_numel_info = {
    _numel_ranges,
    _numel_encodings
};

/* Chip information structure */
static cdk_xgs_chip_info_t bcm56334_b0_chip_info = {
...
extern int
bcm56334_b0_setup(cdk_dev_t *dev);

int
bcm56334_b0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56334_b0_chip_info;
