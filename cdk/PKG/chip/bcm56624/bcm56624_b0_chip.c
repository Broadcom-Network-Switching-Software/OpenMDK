...
/* Block types */
const char *bcm56624_b0_blktype_names[] = {
    "cmic",
    "epipe",
    "esm",
    "gxport",
...
/* Block structures */
cdk_xgs_block_t bcm56624_b0_blocks[] = 
{
    { BCM56624_B0_BLKTYPE_GXPORT,       6,      CDK_PBMP_1(0x10000000) },
    { BCM56624_B0_BLKTYPE_GXPORT,       7,      CDK_PBMP_1(0x20000000) },
    { BCM56624_B0_BLKTYPE_GXPORT,       8,      CDK_PBMP_1(0x40000000) },
    { BCM56624_B0_BLKTYPE_GXPORT,       9,      CDK_PBMP_1(0x80000000) },
    { BCM56624_B0_BLKTYPE_SPORT,        1,      CDK_PBMP_1(0x00000002) },
    { BCM56624_B0_BLKTYPE_XGPORT,       2,      CDK_PBMP_1(0x00003ffc) },
    { BCM56624_B0_BLKTYPE_XGPORT,       3,      CDK_PBMP_1(0x03ffc000) },
    { BCM56624_B0_BLKTYPE_XGPORT,       4,      CDK_PBMP_2(0x04000000, 0x000007ff) },
    { BCM56624_B0_BLKTYPE_XGPORT,       5,      CDK_PBMP_2(0x08000000, 0x003ff800) },
    { BCM56624_B0_BLKTYPE_IPIPE,        10,     CDK_PBMP_2(0xffffffff, 0x003fffff) },
    { BCM56624_B0_BLKTYPE_EPIPE,        11,     CDK_PBMP_2(0xffffffff, 0x003fffff) },
    { BCM56624_B0_BLKTYPE_MMU,          12,     CDK_PBMP_2(0xffffffff, 0x003fffff) },
    { BCM56624_B0_BLKTYPE_ESM,          14,     CDK_PBMP_2(0xffffffff, 0x003fffff) }
};
...
cdk_xgs_numel_info_t bcm56624_b0_numel_info = {
    _numel_ranges,
    _numel_encodings
};

/* Chip information structure */
static cdk_xgs_chip_info_t bcm56624_b0_chip_info = {
    ...
    BCM56624_B0_CHIP_FLAG_EN_HL1 |
    BCM56624_B0_CHIP_FLAG_EN_HL4 |
    0,
...
extern int
bcm56624_b0_setup(cdk_dev_t *dev);

int
bcm56624_b0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56624_b0_chip_info;
