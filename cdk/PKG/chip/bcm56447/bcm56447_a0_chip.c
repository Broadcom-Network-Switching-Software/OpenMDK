...
static cdk_xgsm_chip_info_t bcm56447_a0_chip_info = {
    ...
    CDK_PBMP_2(0x0001ffff, 0x00000008),

    /* Chip flags */
    BCM56440_A0_CHIP_FLAG_LLS_WORKAROUND |
    BCM56440_A0_CHIP_FLAG_GEX16_MODE |
    0,
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56447_a0_setup(cdk_dev_t *dev);

int
bcm56447_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56447_a0_chip_info;
