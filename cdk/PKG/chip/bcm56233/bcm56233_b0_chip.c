...
static cdk_xgsd_chip_info_t bcm56233_b0_chip_info = {
    ...
    CDK_PBMP_1(0x01e0001f),

    /* Chip flags */
    CDK_XGSD_CHIP_FLAG_IPROC |
    BCM56260_B0_CHIP_FLAG_FREQ37 |
    0,
...
extern int
bcm56233_b0_setup(cdk_dev_t *dev);

int
bcm56233_b0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56233_b0_chip_info;
