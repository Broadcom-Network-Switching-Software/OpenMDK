...
/* Block types */
const char *bcm56524_b0_blktype_names[] = {
    "cmic",
    "epipe",
    "gport",
    "gxport",
...
/* Block structures */
cdk_xgs_block_t bcm56524_b0_blocks[] = 
{
    { BCM56524_B0_BLKTYPE_GPORT,        6,      CDK_PBMP_1(0x00003ffc) },
    { BCM56524_B0_BLKTYPE_GPORT,        7,      CDK_PBMP_1(0x03ffc000) },
    { BCM56524_B0_BLKTYPE_GXPORT,       8,      CDK_PBMP_1(0x04000000) },
    { BCM56524_B0_BLKTYPE_GXPORT,       9,      CDK_PBMP_1(0x08000000) },
    { BCM56524_B0_BLKTYPE_GXPORT,       10,     CDK_PBMP_1(0x10000000) },
    { BCM56524_B0_BLKTYPE_GXPORT,       11,     CDK_PBMP_1(0x20000000) },
    { BCM56524_B0_BLKTYPE_SPORT,        12,     CDK_PBMP_1(0x00000002) },
    { BCM56524_B0_BLKTYPE_XQPORT,       16,     CDK_PBMP_2(0xc0000000, 0x00000003) },
    { BCM56524_B0_BLKTYPE_XQPORT,       17,     CDK_PBMP_2(0x00000000, 0x0000003c) },
    { BCM56524_B0_BLKTYPE_XQPORT,       18,     CDK_PBMP_2(0x00000000, 0x000003c0) },
    { BCM56524_B0_BLKTYPE_XQPORT,       19,     CDK_PBMP_2(0x00000000, 0x00003c00) },
    { BCM56524_B0_BLKTYPE_XQPORT,       20,     CDK_PBMP_2(0x00000000, 0x0003c000) },
    { BCM56524_B0_BLKTYPE_XQPORT,       21,     CDK_PBMP_2(0x00000000, 0x003c0000) },
    { BCM56524_B0_BLKTYPE_IPIPE,        0,      CDK_PBMP_2(0xffffffff, 0x007fffff) },
    { BCM56524_B0_BLKTYPE_EPIPE,        1,      CDK_PBMP_2(0xffffffff, 0x007fffff) },
    { BCM56524_B0_BLKTYPE_MMU,          2,      CDK_PBMP_2(0xffffffff, 0x01ffffff) }
};

/* Symbol table */
#if CDK_CONFIG_INCLUDE_CHIP_SYMBOLS == 1
#if CDK_CONFIG_CHIP_SYMBOLS_USE_DSYMS == 1
extern cdk_symbols_t bcm56524_b0_dsymbols;
#else
extern cdk_symbols_t bcm56524_b0_symbols;
#endif
#endif
...
extern uint32_t
bcm56524_b0_blockport_addr(int block, int port, uint32_t offset);
...
cdk_xgs_numel_info_t bcm56524_b0_numel_info = {
    _numel_ranges,
    _numel_encodings
};

/* Chip information structure */
static cdk_xgs_chip_info_t bcm56524_b0_chip_info = {

    /* CMIC block */
    BCM56524_B0_CMIC_BLOCK,

    /* Other (non-CMIC) block types */
    8,
    bcm56524_b0_blktype_names,

    /* Address calculation */
    bcm56524_b0_blockport_addr,
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56524_b0_setup(cdk_dev_t *dev);

int
bcm56524_b0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56524_b0_chip_info;
