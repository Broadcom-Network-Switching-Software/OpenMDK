...
static cdk_xgs_chip_info_t bcm56132_b0_chip_info = {
    ...
    BCM56334_B0_CHIP_FLAG_FE_ONLY |
    BCM56334_B0_CHIP_FLAG_HL25 |
    0,
...
extern int
bcm56132_b0_setup(cdk_dev_t *dev);

int
bcm56132_b0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56132_b0_chip_info;
