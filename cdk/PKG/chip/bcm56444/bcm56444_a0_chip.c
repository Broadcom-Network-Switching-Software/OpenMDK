...
static cdk_xgsm_chip_info_t bcm56444_a0_chip_info = {
    ...
    BCM56440_A0_CHIP_FLAG_FE_MODE |
    BCM56440_A0_CHIP_FLAG_HG13 |
    BCM56440_A0_CHIP_FLAG_HGL25 |
    0,
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56444_a0_setup(cdk_dev_t *dev);

int
bcm56444_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56444_a0_chip_info;
