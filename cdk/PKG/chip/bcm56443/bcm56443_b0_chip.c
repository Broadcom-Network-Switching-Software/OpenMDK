...
static cdk_xgsm_chip_info_t bcm56443_b0_chip_info = {
    ...
    /* Chip flags */
    BCM56440_B0_CHIP_FLAG_EIGHTX25G_MODE |
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56443_b0_setup(cdk_dev_t *dev);

int
bcm56443_b0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56443_b0_chip_info;
