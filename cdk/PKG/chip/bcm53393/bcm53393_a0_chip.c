...
static cdk_port_map_port_t _ports[] = {
    0, 2, 6, 10, 14, 18, 22, 26, 27, 28, 29, 30, 31, 32, 33
};
#endif
...
static cdk_xgsm_chip_info_t bcm53393_a0_chip_info = {
...
extern int
bcm53393_a0_setup(cdk_dev_t *dev);

int
bcm53393_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm53393_a0_chip_info;
