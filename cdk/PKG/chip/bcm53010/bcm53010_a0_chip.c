...
/* Block types */
const char *bcm53010_a0_blktype_names[] = {
    "cpic",
    "exp",
    "gpic",
    "spi",
...
/* Block structures */
cdk_robo_block_t bcm53010_a0_blocks[] = 
{
    { BCM53010_A0_BLKTYPE_GPIC,       CDK_PBMP_1(0x000000bf) },
    { BCM53010_A0_BLKTYPE_CPIC,       CDK_PBMP_1(0x00000100) },
    { BCM53010_A0_BLKTYPE_EXP,        CDK_PBMP_1(0x000001bf) },
    { BCM53010_A0_BLKTYPE_SPI,        CDK_PBMP_1(0x000001bf) },
    { BCM53010_A0_BLKTYPE_SYS,        CDK_PBMP_1(0x000001bf) }
};
...
static cdk_robo_chip_info_t bcm53010_a0_chip_info = {
...
/* Declare function first to prevent compiler warnings */
extern int
bcm53010_a0_setup(cdk_dev_t *dev);

int
bcm53010_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm53010_a0_chip_info;
