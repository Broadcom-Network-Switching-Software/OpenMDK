...
/* Block types */
const char *bcm53600_a0_blktype_names[] = {
    "cpic",
    "epic",
    "exp",
    "gpic",
...
/* Block structures */
cdk_robo_block_t bcm53600_a0_blocks[] = 
{
    { BCM53600_A0_BLKTYPE_EPIC,       CDK_PBMP_1(0x00ffffff) },
    { BCM53600_A0_BLKTYPE_GPIC,       CDK_PBMP_1(0x1e000000) },
    { BCM53600_A0_BLKTYPE_CPIC,       CDK_PBMP_1(0x01000000) },
    { BCM53600_A0_BLKTYPE_EXP,        CDK_PBMP_1(0x1fffffff) },
    { BCM53600_A0_BLKTYPE_SPI,        CDK_PBMP_1(0x1fffffff) },
    { BCM53600_A0_BLKTYPE_SYS,        CDK_PBMP_1(0x1fffffff) }
};
...
static cdk_robo_chip_info_t bcm53600_a0_chip_info = {
...
/* Declare function first to prevent compiler warnings */
extern int
bcm53600_a0_setup(cdk_dev_t *dev);

int
bcm53600_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm53600_a0_chip_info;
