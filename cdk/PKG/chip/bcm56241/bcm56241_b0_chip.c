...
static cdk_xgsm_chip_info_t bcm56241_b0_chip_info = {
    ...
    /* Chip flags */
    BCM56440_B0_CHIP_FLAG_GEX6_MODE |
    BCM56440_B0_CHIP_FLAG_GE25_MODE |
    0,
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56241_b0_setup(cdk_dev_t *dev);

int
bcm56241_b0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56241_b0_chip_info;
