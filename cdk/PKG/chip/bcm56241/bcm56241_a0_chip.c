...
static cdk_xgsm_chip_info_t bcm56241_a0_chip_info = {
    ...
    CDK_PBMP_2(0xf8000001, 0x0000000f),

    /* Chip flags */
    BCM56440_A0_CHIP_FLAG_GEX6_MODE |
    BCM56440_A0_CHIP_FLAG_GE25_MODE |
    0,
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56241_a0_setup(cdk_dev_t *dev);

int
bcm56241_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56241_a0_chip_info;
