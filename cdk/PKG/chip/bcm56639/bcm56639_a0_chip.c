...
static cdk_xgs_chip_info_t bcm56639_a0_chip_info = {
    ...
    BCM56634_A0_CHIP_FLAG_XQ0_XE |
    BCM56634_A0_CHIP_FLAG_XQ2_XE |
    BCM56634_A0_CHIP_FLAG_XQ3_XE |
    BCM56634_A0_CHIP_FLAG_XQ5_XE |
    0,
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56639_a0_setup(cdk_dev_t *dev);

int
bcm56639_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56639_a0_chip_info;
