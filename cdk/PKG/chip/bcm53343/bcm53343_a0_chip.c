...
static cdk_port_map_port_t _ports[] = {
    0, 9, 8, 7, 6, 5, 4, 3, 2, 10, 11, 12, 13, 14, 15, 16, 17, 26, 27, 28, 29
};
#endif
...
static cdk_xgsm_chip_info_t bcm53343_a0_chip_info = {
    ...
    CDK_PBMP_1(0x3c03fffd),

    /* Chip flags */
    CDK_XGSM_CHIP_FLAG_IPROC |
    BCM56150_A0_CHIP_FLAG_TSC_1G |
    BCM56150_A0_CHIP_FLAG_GE16 |
    0,
...
extern int
bcm53343_a0_setup(cdk_dev_t *dev);

int
bcm53343_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm53343_a0_chip_info;
