...
/* Block types */
const char *bcm56800_a0_blktype_names[] = {
    "bsafe",
    "cmic",
    "epipe",
    "gxport",
...
/* Block structures */
cdk_xgs_block_t bcm56800_a0_blocks[] = 
{
    { BCM56800_A0_BLKTYPE_GXPORT,       0,      CDK_PBMP_1(0x000fffff) },
    { BCM56800_A0_BLKTYPE_IPIPE,        1,      CDK_PBMP_1(0x001fffff) },
    { BCM56800_A0_BLKTYPE_EPIPE,        4,      CDK_PBMP_1(0x001fffff) },
    { BCM56800_A0_BLKTYPE_MMU,          13,     CDK_PBMP_1(0x001fffff) },
    { BCM56800_A0_BLKTYPE_BSAFE,        14,     CDK_PBMP_1(0x001fffff) }
};
...
static cdk_xgs_chip_info_t bcm56800_a0_chip_info = {
...
extern int
bcm56800_a0_setup(cdk_dev_t *dev);

int
bcm56800_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm56800_a0_chip_info;
