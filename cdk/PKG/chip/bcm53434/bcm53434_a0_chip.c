...
static cdk_xgsd_chip_info_t bcm53434_a0_chip_info = {
    ...
    CDK_PBMP_2(0xfffffc01, 0x00000003),

    /* Chip flags */
    CDK_XGSD_CHIP_FLAG_IPROC |
    BCM56160_A0_CHIP_FLAG_FREQ75 |
    BCM56160_A0_CHIP_FLAG_NO_TSC |
    0,
...
extern int
bcm53434_a0_setup(cdk_dev_t *dev);

int
bcm53434_a0_setup(cdk_dev_t *dev)
{
    dev->chip_info = &bcm53434_a0_chip_info;
