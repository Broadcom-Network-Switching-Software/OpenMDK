...
extern int cdk_shcmd_xgsm_get(int argc, char *argv[]);

#define CDK_SHCMD_XGSM_GET_DESC  "Get chip register/memory contents"
#define CDK_SHCMD_XGSM_GET_SYNOP \
"expr [nz] [raw] [flags=symflags]"
#define CDK_SHCMD_XGSM_GET_HELP \
...
#define CDK_SHCMD_XGSM_GET_HELP_2 \
