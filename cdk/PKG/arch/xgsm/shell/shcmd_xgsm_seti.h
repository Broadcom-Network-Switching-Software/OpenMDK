...
extern int cdk_shcmd_xgsm_seti(int argc, char *argv[]);

#define CDK_SHCMD_XGSM_SETI_DESC  "Modify chip register/memory contents (raw)"
#define CDK_SHCMD_XGSM_SETI_SYNOP \
"access-type addr value[:value2[:value3 ... ]] [size]"
#define CDK_SHCMD_XGSM_SETI_HELP \
