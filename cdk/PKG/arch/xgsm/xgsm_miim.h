...
#ifndef __XGSM_MIIM_H__
#define __XGSM_MIIM_H__

/* 
 * Definitions for 'phy_addr' parameter.
 *
 * Note 1:
 * CDK_XGSM_MIIM_BUS_2 overrides CDK_XGSM_MIIM_BUS_1.
 *
 * Note 2:
 * If neither CDK_XGSM_MIIM_BUS_1 or CDK_XGSM_MIIM_BUS_2 is set
 ...
 *
 * Note 5:
 * Second generation register layout replaces CDK_XGSM_MIIM_BUS_1,
 * CDK_XGSM_MIIM_BUS_2 and CDK_XGSM_MIIM_INTERNAL with a 3-bit
 * bus ID and a new bit for selecting between internal and
 * external MII buses.
 */
#define CDK_XGSM_MIIM_BUS_2      0x00000100 /* Select external MII bus #2 */
#define CDK_XGSM_MIIM_INTERNAL   0x00000080 /* Select internal SerDes MII bus */
#define CDK_XGSM_MIIM_BUS_1      0x00000040 /* Select external MII bus #1 */
...
extern int 
cdk_xgsm_miim_iblk_write(int unit, uint32_t phy_addr, uint32_t reg, uint32_t val); 
