...
int cdk_xgsm_reg_index_valid(int unit, int port, int regidx,
                            int encoding, int regidx_max)
{
    cdk_xgsm_numel_info_t *numel_info = CDK_XGSM_INFO(unit)->numel_info;
    cdk_xgsm_numel_range_t *numel_range;
    int idx;
    int *range_id;
