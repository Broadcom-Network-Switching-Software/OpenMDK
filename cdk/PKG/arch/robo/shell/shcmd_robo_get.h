...
extern int cdk_shcmd_robo_get(int argc, char *argv[]);

#define CDK_SHCMD_ROBO_GET_DESC  "Get chip register/memory contents"
#define CDK_SHCMD_ROBO_GET_SYNOP \
"expr [nz] [raw] [flags=symflags]"
#define CDK_SHCMD_ROBO_GET_HELP \
...
#define CDK_SHCMD_ROBO_GET_HELP_2 \
