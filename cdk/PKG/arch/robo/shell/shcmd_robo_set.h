...
extern int cdk_shcmd_robo_set(int argc, char *argv[]);

#define CDK_SHCMD_ROBO_SET_DESC  "Modify chip register/memory contents"
#define CDK_SHCMD_ROBO_SET_SYNOP \
"expr value [value [value ... ]] [field=value [field=value ... ]]"
#define CDK_SHCMD_ROBO_SET_HELP \
