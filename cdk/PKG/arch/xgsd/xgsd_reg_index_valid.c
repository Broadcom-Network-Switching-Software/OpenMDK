...
int cdk_xgsd_reg_index_valid(int unit, int port, int regidx,
                            int encoding, int regidx_max)
{
    cdk_xgsd_numel_info_t *numel_info = CDK_XGSD_INFO(unit)->numel_info;
    cdk_xgsd_numel_range_t *numel_range;
    int idx;
    int *range_id;
