...
#define SCMH_ACCTYPE_GET(d)     __F_GET(d,14,5)
#define SCMH_ACCTYPE_SET(d,v)   __F_SET(d,14,5,v)
#define SCMH_DSTBLK_GET(d)      __F_GET(d,19,7)
#define SCMH_DSTBLK_SET(d,v)    __F_SET(d,19,7,v)
...
#define SCGR_ERROR_GET(d)       __F_GET(d,24,4)
#define SCGR_ERROR_SET(d,v)     __F_SET(d,24,4,v)
#define SCGR_TYPE_GET(d)        __F_GET(d,28,4)
#define SCGR_TYPE_SET(d,v)      __F_SET(d,28,4,v)
...
extern int cdk_xgsd_schan_op(int unit, schan_msg_t* msg,
