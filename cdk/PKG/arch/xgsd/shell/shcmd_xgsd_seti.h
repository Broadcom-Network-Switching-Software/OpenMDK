...
extern int cdk_shcmd_xgsd_seti(int argc, char *argv[]);

#define CDK_SHCMD_XGSD_SETI_DESC  "Modify chip register/memory contents (raw)"
#define CDK_SHCMD_XGSD_SETI_SYNOP \
"access-type addr value[:value2[:value3 ... ]] [size]"
#define CDK_SHCMD_XGSD_SETI_HELP \
