...
extern int cdk_shcmd_xgsd_get(int argc, char *argv[]);

#define CDK_SHCMD_XGSD_GET_DESC  "Get chip register/memory contents"
#define CDK_SHCMD_XGSD_GET_SYNOP \
"expr [nz] [raw] [flags=symflags]"
#define CDK_SHCMD_XGSD_GET_HELP \
...
#define CDK_SHCMD_XGSD_GET_HELP_2 \
